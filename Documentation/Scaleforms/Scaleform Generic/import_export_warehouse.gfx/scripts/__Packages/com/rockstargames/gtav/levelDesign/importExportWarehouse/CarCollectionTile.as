class com.rockstargames.gtav.levelDesign.importExportWarehouse.CarCollectionTile
{
   ...
   function init(vehicleCollection, imageManager)
   {
      if(!this._hasBeenInitialised && vehicleCollection)
      {
         ...
         this._view.collectionBonus.text = this._view.collectionBonus.text + (" $" + com.rockstargames.gtav.levelDesign.IMPORT_EXPORT_WAREHOUSE.formatNumber(this._value));
         ...
         var _loc8_ = vehicleCollection.__get__vehicles().length;
         var _loc2_ = 0;
         while(_loc2_ < _loc8_)
         {
            ...
            _loc4_.initImageAndName(vehicleCollection.__get__vehicles()[_loc2_],imageManager);
         ...
         this._exportButton = new com.rockstargames.gtav.levelDesign.importExportWarehouse.Button(vehicleCollection.__get__id(),this._view.exportButton,"IEW_EXPORT_COLLECTION_BUTTON",com.rockstargames.gtav.levelDesign.IMPORT_EXPORT_WAREHOUSE.IS_DEBUG);
