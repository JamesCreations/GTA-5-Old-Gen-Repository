class com.rockstargames.gtav.levelDesign.importExportWarehouse.ImageManager
{
   static var USE_REFERENCE_COUNTING = true;
   ...
   {
      if(com.rockstargames.gtav.levelDesign.importExportWarehouse.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == "loaded")
      {
      ...
      else
      {
         ...
         {
            com.rockstargames.ui.game.GameInterface.call("REQUEST_TXD_AND_ADD_REF",com.rockstargames.ui.game.GameInterface.GENERIC_TYPE,"IMPORT_EXPORT_WAREHOUSE",txd,id,true);
   ...
   function dispose()
   {
      ...
      {
         com.rockstargames.ui.game.GameInterface.call("REMOVE_TXD_REF",com.rockstargames.ui.game.GameInterface.GENERIC_TYPE,"IMPORT_EXPORT_WAREHOUSE",_loc2_);
      }
   }
}
