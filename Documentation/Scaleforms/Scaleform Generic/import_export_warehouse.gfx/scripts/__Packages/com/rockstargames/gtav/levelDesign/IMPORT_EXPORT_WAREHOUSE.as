class com.rockstargames.gtav.levelDesign.IMPORT_EXPORT_WAREHOUSE extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function UPDATE_VEHICLE(id, value, collectionValue, selected, owned, rangeCategory, actualValue)
   {
      ...
      if(_loc6_)
      {
         var _loc4_ = new com.rockstargames.gtav.levelDesign.importExportWarehouse.Vehicle(_loc6_.__get__id(),_loc6_.__get__texture(),_loc6_.__get__texture(),_loc6_.__get__category(),value,collectionValue,selected,owned,rangeCategory,actualValue);
         var _loc5_ = false;
         var _loc2_ = 0;
   ...
   function UPDATE_COLLECTION(id, value, selected, disabled)
   {
      ...
      if(_loc7_)
      {
         ...
         while(_loc4_ < _loc8_)
         {
            ...
            _loc3_.__set__associatedCollection(id);
            if(_loc3_.__get__owned())
            {
               _loc11_ = _loc11_ + 1;
            }
            _loc9_.push(_loc3_);
   ...
   function GET_CURRENT_TAB_ID()
   {
      if(this._currScreen instanceof com.rockstargames.gtav.levelDesign.importExportWarehouse.WarehouseScreen)
      {
         return (com.rockstargames.gtav.levelDesign.importExportWarehouse.WarehouseScreen)this._currScreen.__get__activeTabIndex();
      }
   }
   ...
   function __set__vehicles(value)
   {
      ...
      return this.__get__vehicles();
   }
   function __set__collections(value)
   {
      this._collections = value;
      return this.__get__collections();
   }
