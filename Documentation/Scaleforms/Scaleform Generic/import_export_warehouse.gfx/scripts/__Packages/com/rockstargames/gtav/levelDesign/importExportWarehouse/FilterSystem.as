class com.rockstargames.gtav.levelDesign.importExportWarehouse.FilterSystem
{
   ...
   function __get__filterOptionButtons()
   {
      var _loc3_ = [];
      var _loc2_ = 0;
   ...
   function __get__currentFilterFlag()
   {
      return this._currentFilterFlag;
   }
   function __get__currentSortIndex()
   {
      return this._currentSortIndex;
   }
   function __get__currentSortOrder()
   {
      return this._currentSortOrder;
   }
   function __get__currentSortField()
   {
      return this._currentSortField;
   }
   function __get__areFilterOptionsShowing()
   {
