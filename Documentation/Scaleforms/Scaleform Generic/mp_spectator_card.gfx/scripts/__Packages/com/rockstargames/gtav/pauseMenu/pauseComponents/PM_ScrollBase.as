class com.rockstargames.gtav.pauseMenu.pauseComponents.PM_ScrollBase extends MovieClip
{
   ...
   function mPressLeft()
   {
      com.rockstargames.ui.game.GameInterface.call("HANDLE_SCROLL_CLICK",com.rockstargames.ui.game.GameInterface.PAUSE_TYPE,com.rockstargames.gtav.pauseMenu.pauseComponents.PM_ScrollBase.SCROLL_DIRECTION_LEFT,this._columnID);
   }
   function mPressRight()
   {
      com.rockstargames.ui.game.GameInterface.call("HANDLE_SCROLL_CLICK",com.rockstargames.ui.game.GameInterface.PAUSE_TYPE,com.rockstargames.gtav.pauseMenu.pauseComponents.PM_ScrollBase.SCROLL_DIRECTION_RIGHT,this._columnID);
   }
   function mPressUp()
   {
      com.rockstargames.ui.game.GameInterface.call("HANDLE_SCROLL_CLICK",com.rockstargames.ui.game.GameInterface.PAUSE_TYPE,com.rockstargames.gtav.pauseMenu.pauseComponents.PM_ScrollBase.SCROLL_DIRECTION_UP,this._columnID);
   }
   function mPressDown()
   {
      com.rockstargames.ui.game.GameInterface.call("HANDLE_SCROLL_CLICK",com.rockstargames.ui.game.GameInterface.PAUSE_TYPE,com.rockstargames.gtav.pauseMenu.pauseComponents.PM_ScrollBase.SCROLL_DIRECTION_DOWN,this._columnID);
   }
