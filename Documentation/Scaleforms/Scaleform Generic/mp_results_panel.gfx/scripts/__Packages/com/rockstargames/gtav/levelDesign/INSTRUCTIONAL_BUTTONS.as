class com.rockstargames.gtav.levelDesign.INSTRUCTIONAL_BUTTONS extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function CONSTRUCTION_INNARDS()
   {
      ...
      this.MOUSE_EVT.__set__UI_MOVIE(com.rockstargames.ui.mouse.MOUSE_EVENTS.UI_MOVIE_INSTRUCTIONAL_BUTTONS);
   ...
   function CLEAR_BACKGROUNDS()
   {
      ...
      while(_loc2_ < this._allBackgroundRectangles.length)
      {
         ...
         delete register3.onRollOver;
         delete register3.onRollOut;
         delete register3.onReleaseOutside;
   ...
   function SET_BACKGROUND()
   {
      ...
      while(_loc2_ < this.backgrounds.length)
      {
         ...
         if(this.CLICKABLE)
         {
            ...
            this._backgroundMouseCatcher.onRollOut = mx.utils.Delegate.create(this,this.processRollOut).backgroundIndex = _loc2_;
      ...
      if(textString != undefined)
      {
         ...
         if(_loc3_.length > 1)
         {
            ...
            if(_loc5_.length > 1)
            {
               ...
               {
                  textString = textString + _loc3_[0];
               }
               ...
               {
                  textString = textString + _loc3_[_loc3_.length];
               }
            }
         }
         this.parseForGamerName(_loc2_,textString);
      }
      _loc2_._y = _loc2_._y + _loc2_.textHeight / 5;
      return _loc2_;
   }
   ...
   {
      this.SET_MAX_WIDTH(1);
      this.SET_DATA_SLOT(5,"T_www","Wide");
      this.SET_DATA_SLOT(4,"t_w","Wide");
      this.SET_DATA_SLOT(3,"w_wsss","Standard");
      this.SET_DATA_SLOT(2,"b_45","Browse");
      this.SET_DATA_SLOT(1,"b_26","Look Around");
      this.SET_DATA_SLOT(0,"b_30","Select");
