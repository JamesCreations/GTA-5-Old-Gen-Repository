class com.rockstargames.ui.components.GUIView
{
   ...
   function displayView()
   {
      ...
      {
         com.rockstargames.ui.utils.Debug.log("MEMORY LEAK WARNING:  DISPLAY_VIEW invoked without SET_DATA_SLOT_EMPTY to clear already existing display items.  This will almost surely cause a memory leak!");
      }
