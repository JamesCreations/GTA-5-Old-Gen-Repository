class com.rockstargames.gtav.pauseMenu.pauseComponents.PauseMenuComponentBase extends com.rockstargames.ui.components.GUIController
{
   ...
   var canMouseNav = false;
   var footerScrollOverrideIndex = -1;
   ...
   function SET_FOCUS(isFocused)
   {
      ...
      while(_loc2_ < _loc4_.length)
      {
         ...
         _loc3_.__set__highlighted(!isFocused?false:this.model.getCurrentView().highlightedItem == _loc2_);
         _loc2_ = _loc2_ + 1;
      }
      if(this.scrollBase != undefined)
      {
   ...
   function SEND_COLUMN_PARAMS()
   {
      ...
      {
         var _loc3_ = _loc4_[_loc2_];
         _loc3_.__set__columnID(this.columnID);
         com.rockstargames.ui.utils.Debug.log(_loc2_ + "  " + _loc3_ + " = SET COLUMNID to: " + _loc3_.__get__columnID());
         _loc2_ = _loc2_ + 1;
      }
      this.setScrollColumnID();
   }
