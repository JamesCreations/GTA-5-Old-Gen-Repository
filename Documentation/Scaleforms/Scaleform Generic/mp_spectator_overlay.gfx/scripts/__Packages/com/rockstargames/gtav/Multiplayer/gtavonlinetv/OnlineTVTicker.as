class com.rockstargames.gtav.Multiplayer.gtavonlinetv.OnlineTVTicker extends MovieClip
{
   ...
   function ADD_TICKER_TEXT(enum, str)
   {
      ...
      var _loc4_ = this.ticks.length != 0?this.ticks[this.ticks.length - 1]._x + this.ticks[this.ticks.length - 1]._width:0;
      this.tickCount = this.tickCount + 1;
      var _loc3_ = (com.rockstargames.gtav.Multiplayer.gtavonlinetv.OnlineTVTick)this.container.attachMovie("Tick","t" + this.tickCount,this.container.getNextHighestDepth(),{_x:_loc4_});
   ...
   function updateWidth(value)
   {
      ...
      this.container._x = this.container._x - _loc2_;
   }
   function updateDisplay()
   {
      ...
      {
         _loc2_ = (com.rockstargames.gtav.Multiplayer.gtavonlinetv.OnlineTVTick)this.ticks.shift();
         ...
         this.container._x = this.container._x + _loc5_;
         var _loc4_ = 0;
         while(_loc4_ < this.ticks.length)
         {
            _loc2_ = this.ticks[_loc4_];
            _loc2_._x = _loc2_._x - _loc5_;
            _loc4_ = _loc4_ + 1;
         }
      }
      var _loc3_ = 0;
      ...
      while(_loc4_ < this.ticks.length)
      {
         ...
         if(_loc2_._x != _loc3_)
         {
            ...
            {
               _loc2_._x = _loc2_._x - (_loc2_._x - _loc3_) / 10;
            }
         }
         _loc3_ = _loc2_._x + _loc2_.__get__tickWidth();
         _loc4_ = _loc4_ + 1;
      }
   }
}
