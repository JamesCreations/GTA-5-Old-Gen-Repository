class com.rockstargames.gtav.levelDesign.SHOP_MENU extends com.rockstargames.ui.components.GUIController
{
   ...
   function INITIALISE(mc)
   {
      ...
      (com.rockstargames.gtav.levelDesign.ShopModel)this.model.__set__arrows([this.CONTENT.headingMC.arrowMC,this.CONTENT.popupMC.arrowMC]);
   }
   ...
   {
      var _loc2_ = this.model.getCurrentView(0).__get__maxitems();
      if(_loc2_ > 10)
      {
         _loc2_ = 10;
      }
   ...
   function RESIZE_BACKGROUND(_viewIndex)
   {
      ...
      if(this.model.getCurrentView().__get__maxitems() > this.displayableItems)
      {
         ...
         this.scrollBar.setGutterHeight(this.model.getCurrentView(0).visibleItems,this.model.getCurrentView().__get__maxitems());
         this.model.__set__scrollBar(this.scrollBar);
         this.scrollBar.__set__scrollpercent(0);
      ...
      else if(this.scrollBar != undefined)
      {
         ...
         this.model.__set__scrollBar(undefined);
         this.SHOW_SCROLL_HINTS(false);
      }
   }
