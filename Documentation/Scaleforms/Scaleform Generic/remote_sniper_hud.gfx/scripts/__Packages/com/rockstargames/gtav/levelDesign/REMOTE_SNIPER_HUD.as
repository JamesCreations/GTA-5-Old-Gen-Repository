class com.rockstargames.gtav.levelDesign.REMOTE_SNIPER_HUD extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function update()
   {
      ...
      if(Key.isDown(38))
      {
         this.zoom = this.zoom + this.aspeed;
         if(this.zoom > 100)
         {
            this.zoom = this.zoom - 100;
         }
         this.SET_WIND(this.zoom,true);
         this.szone = this.szone + 0.05;
      }
      if(Key.isDown(40))
      {
         this.zoom = this.zoom - this.aspeed;
   ...
   function initScreenLayout()
   {
      ...
      var _loc5_ = this.CONTENT.scopeMC.circlesMC;
      this.positionToScreenLayout(_loc5_,"xCC",true);
      var _loc7_ = this.CONTENT.scopeMC.crosshairMC;
      this.positionToScreenLayout(_loc7_,"xCC",true);
      var _loc2_ = this.CONTENT.scopeMC.compassMC;
      this.positionToScreenLayout(_loc2_,"xCT",true);
      var _loc4_ = this.CONTENT.scopeMC.compassWordsMC;
      _loc4_._x = this.safeLeft + (this.safeRight - this.safeLeft) / 2;
      _loc4_._y = _loc2_._y + _loc2_._height + 16;
      var _loc6_ = this.CONTENT.scopeMC.windGaugeMC;
      _loc6_._x = this.safeRight - 127;
   }
