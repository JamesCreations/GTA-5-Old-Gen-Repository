class com.rockstargames.gtav.levelDesign.ShopModelDLC extends com.rockstargames.ui.components.GUIModel
{
   ...
   function setItem(_currentView, _itemIndex)
   {
      ...
      {
         var _loc3_ = 100 * ((_currentView.__get__maxitems() - _currentView.visibleItems) / _currentView.__get__maxitems());
         this.__get__scrollBar().__set__scrollpercent(_loc3_ * (_itemIndex / (_currentView.__get__maxitems() - 1)));
      }
   }
