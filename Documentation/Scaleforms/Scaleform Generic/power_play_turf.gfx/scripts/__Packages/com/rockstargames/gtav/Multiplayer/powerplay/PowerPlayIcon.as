class com.rockstargames.gtav.Multiplayer.powerplay.PowerPlayIcon
{
   ...
   {
      this.CONTAINER = mc;
      this.setTeamColours(teamOneColour,teamTwoColour);
   ...
   function updateTimer(teamOnePct, teamTwoPct)
   {
      ...
      else
      {
         if(_loc3_ > 0)
         {
            ...
            this.drawIcon(this.teamOne,_loc3_,this._teamOneColourHex);
         }
         else
         {
            this.teamOne.clear();
         ...
         if(_loc2_ > 0)
         {
            ...
            this.drawIcon(this.teamTwo,_loc2_,this._teamTwoColourHex);
         }
         else
         {
            this.teamTwo.clear();
   ...
   function drawIcon(ICON, pct, colour)
   {
      ...
      while(_loc2_ <= _loc4_)
      {
         ...
         _loc2_ = _loc2_ + com.rockstargames.gtav.Multiplayer.powerplay.PowerPlayIcon.ANGLE_GRANULARITY;
      }
   ...
   function setTeamColours(teamOne, teamTwo)
   {
