class com.rockstargames.gtav.Multiplayer.POWER_PLAY extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function ACTIVATE_ICON(iconID, titleText, strapText, greyOtherIcons, teamColourID)
   {
      ...
      if(teamColourID == 0)
      {
         ...
         _loc11_ = this.CONTENT.MAIN_TITLE_TEAM_ONE.BIG_TEXT_BG_MC;
         _loc12_ = this.CONTENT.MAIN_TITLE_TEAM_ONE.STRAP_LINE;
         _loc13_ = this.CONTENT.MAIN_TITLE_TEAM_ONE.STRAP_LINE_BG;
         this.CONTENT.MAIN_TITLE_TEAM_ONE._alpha = 100;
         this.CONTENT.MAIN_TITLE_TEAM_TWO._alpha = 0;
         _loc10_.BIG_TEXT_TF.textAutoSize = "shrink";
         _loc11_.BIG_TEXT_TF.textAutoSize = "shrink";
         _loc10_.BIG_TEXT_TF.text = titleText;
         _loc11_.BIG_TEXT_TF.text = titleText;
         _loc12_.MESSAGE_TEXT.text = strapText;
         _loc13_.MESSAGE_TEXT.text = strapText;
      }
      if(teamColourID == 1)
      {
         _loc10_ = this.CONTENT.MAIN_TITLE_TEAM_TWO.BIG_TEXT_MC;
         _loc11_ = this.CONTENT.MAIN_TITLE_TEAM_TWO.BIG_TEXT_BG_MC;
         _loc12_ = this.CONTENT.MAIN_TITLE_TEAM_TWO.STRAP_LINE;
         _loc13_ = this.CONTENT.MAIN_TITLE_TEAM_TWO.STRAP_LINE_BG;
      ...
      {
         var _loc2_ = 0;
         var _loc3_ = this.descenders.length;
         while(_loc2_ < _loc3_)
         {
      ...
      _loc11_.BIG_TEXT_TF._y = _loc5_;
      _loc12_._y = _loc10_._y + _loc10_.BIG_TEXT_TF.textHeight + _loc9_;
      _loc13_._y = _loc12_._y + 1;
      if(greyOtherIcons)
      {
         this.surpressIcons();
      }
   ...
   function loop()
   {
      ...
      this.currentPct = this.currentPct - 0.01;
      this.icCurVals[0] = this.icCurVals[0] - 0.001;
      this.icCurVals[1] = this.icCurVals[1] - 0.01;
      this.icCurVals[2] = this.icCurVals[2] - 0.01;
      this.icCurVals[3] = this.icCurVals[3] - 0.01;
      this.icCurVals[4] = this.icCurVals[4] - 0.01;
      this.icCurVals[5] = this.icCurVals[5] - 0.01;
      this.icCurVals[6] = this.icCurVals[6] - 0.01;
      this.icCurVals[7] = this.icCurVals[7] - 0.01;
      this.icCurVals[8] = this.icCurVals[8] - 0.01;
      this.icCurVals[9] = this.icCurVals[9] - 0.01;
      this.icCurVals[10] = this.icCurVals[10] - 0.01;
      this.icCurVals[11] = this.icCurVals[11] - 0.01;
