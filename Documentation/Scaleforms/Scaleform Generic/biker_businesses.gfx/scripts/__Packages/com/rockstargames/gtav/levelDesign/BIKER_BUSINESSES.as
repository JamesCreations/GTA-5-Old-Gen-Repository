class com.rockstargames.gtav.levelDesign.BIKER_BUSINESSES extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function ADD_BUSINESS(id, type, txd, location, description, status, price, salePrice, stockLevel, stockValue, suppliesLevel, canResupply, totalSales, timesRaided, successfulSales, resupplyButtonEnabled, resupplyCost, resupplySaleCost)
   {
      var _loc5_ = new com.rockstargames.gtav.levelDesign.bikerBusinesses.Business(id,type,txd,location,description,status,price,salePrice,stockLevel,stockValue,suppliesLevel,canResupply,totalSales,timesRaided,successfulSales,resupplyButtonEnabled,resupplyCost,resupplySaleCost);
      var _loc4_ = false;
      var _loc2_ = 0;
