class com.rockstargames.gtav.pauseMenu.pauseComponents.PAUSE_MENU_REPLAY_LIST extends com.rockstargames.gtav.pauseMenu.pauseComponents.PauseMenuComponentBase
{
   ...
   {
      super();
      this.dbgID = "PAUSE_MENU_REPLAY_LIST";
   }
   function INITIALISE(mc)
   {
      ...
      this.model.createView(0,{id:0,x:0,y:0,rowSpacing:2,columnSpacing:0,container:this.CONTENT,linkage:["replayMenuListItem"],visibleItems:16,selectstyle:com.rockstargames.ui.components.GUIView.SCROLL_SELECTSTYLE});
   }
