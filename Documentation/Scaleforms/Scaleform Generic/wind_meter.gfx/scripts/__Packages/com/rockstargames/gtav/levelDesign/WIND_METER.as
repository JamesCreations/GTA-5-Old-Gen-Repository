class com.rockstargames.gtav.levelDesign.WIND_METER extends com.rockstargames.gtav.levelDesign.BaseScriptUI
{
   ...
   function __get__arrowRotation()
   {
      return this._arrowRotation;
   }
   function __set__arrowRotation(value)
   {
      ...
      return this.__get__arrowRotation();
   }
   function __get__strength()
   {
      return this._strength;
   }
   function __set__strength(value)
   {
