class com.rockstargames.gtav.levelDesign.YOGA_BUTTONS extends com.rockstargames.gtav.levelDesign.BaseScriptUI
{
   ...
   function SET_HOLD_TIMER(timePercent)
   {
      ...
      if(this.buttonList.length > 0)
      {
         ...
         for(var _loc4_ in this.buttonList)
         {
   ...
   {
      arAngle = arAngle - 90;
      var _loc3_ = this.analogList[buttonID];
      var _loc2_ = 8;
      var _loc6_ = Math.cos(arAngle * 3.141592653589793 / 180) * _loc2_;
      var _loc5_ = Math.sin(arAngle * 3.141592653589793 / 180) * _loc2_;
      _loc3_.stickMC.innerMC._x = _loc6_;
      _loc3_.stickMC.innerMC._y = _loc5_;
   }
