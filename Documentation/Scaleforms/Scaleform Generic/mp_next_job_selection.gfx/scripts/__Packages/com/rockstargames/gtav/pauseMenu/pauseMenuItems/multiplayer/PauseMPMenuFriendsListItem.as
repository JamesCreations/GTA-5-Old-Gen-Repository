class com.rockstargames.gtav.pauseMenu.pauseMenuItems.multiplayer.PauseMPMenuFriendsListItem extends com.rockstargames.gtav.pauseMenu.pauseMenuItems.PauseMenuBaseItem
{
   ...
   function __set__data(_d)
   {
      ...
      if(this.isColour)
      {
         ...
         {
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.tabMC,!_loc4_?this.__get__data()[1]:com.rockstargames.ui.utils.HudColour.HUD_COLOUR_WHITE);
         }
      ...
      else
      {
         ...
         this.crewTagMC.UNPACK_CREW_TAG(_loc3_);
   ...
   function setIcon()
   {
      var _loc2_ = this.__get__data()[4];
      this.labelMC.iconMC.gotoAndStop(_loc2_);
      if(_loc2_ == "RANK_FREEMODE")
      {
         com.rockstargames.gtav.utils.GTAVUIUtils.colourRankIcon(this.labelMC.iconMC.rankMC);
      ...
      if(this.labelMC.iconMC.animIcon)
      {
         this.labelMC.iconMC.animIcon.play();
      }
   }
   function setView(v)
   {
   ...
   function mOver()
   {
      ...
      {
         _level0.TIMELINE.M_OVER_EVENT(this.index,this.__get__columnID());
      }
   }
   function mOut()
   {
   ...
   function mPress()
   {
      ...
      if(this.uniqueID != -1 && _loc2_ != "")
      {
         _level0.TIMELINE.M_PRESS_EVENT(this.index,this.__get__columnID());
      }
   }
}
