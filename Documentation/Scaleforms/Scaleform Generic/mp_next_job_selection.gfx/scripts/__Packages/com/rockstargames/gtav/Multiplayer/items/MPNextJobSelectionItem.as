   ...
   function setData(sTitle, txd, txn, textureLoadType, verifiedType, eIcon, bCheck, rpMult, cashMult, bDisabled, iconCol)
   {
      ...
      if(textureLoadType != -1)
      {
         if(txd != undefined && txn != undefined && txd != "" && txn != "")
         {
            ...
            var _loc4_ = String(_loc2_).split(".");
            var _loc5_ = _loc4_.slice(_loc4_.length - 4).join(".");
            if(textureLoadType == com.rockstargames.gtav.Multiplayer.items.MPNextJobSelectionItem.IMAGE_TYPE_CLOUD)
            {
               _loc2_.addTxdRef(_loc5_,this.transitionInBitmap,this);
            }
            else
            {
               _loc2_.requestTxdRef(_loc5_,_loc8_,this.transitionInBitmap,this);
            }
         }
      ...
      if(verifiedType != undefined)
      {
         ...
         if(!this.verifiedMC)
         {
            this.verifiedMC = (com.rockstargames.gtav.Multiplayer.ROCKSTAR_VERIFIED)this.attachMovie("verified","verifiedMC",this.getNextHighestDepth(),{_x:this.verifiedbgMC._x + _loc6_,_y:this.verifiedbgMC._y + _loc6_});
         }
      ...
      var _loc7_ = rpMult <= 0?0:30;
      this.cashMultTF._y = this.rpMultTF._y + _loc7_;
      this.cashIconMC._y = this.rpIconMC._y + _loc7_;
