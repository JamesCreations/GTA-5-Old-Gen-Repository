class com.rockstargames.gtav.pauseMenu.PAUSE_MENU_SP_CONTENT extends com.rockstargames.gtav.pauseMenu.pauseMenuItems.PauseMenuContentBase
{
   ...
   function SHOW_WARNING_MESSAGE(bShow, columnIndex, numCols, bodyStr, titleStr, bgHeight, txd, txn, imgAlignment, footerStr, bRequestTXD)
   {
      ...
      if(bShow && arguments[1] != undefined)
      {
         ...
         var _loc24_ = this.columnWidth * numCols + 2 * (numCols - 1);
         this.errorMsg.tileBGMC.bgMC._width = this.errorMsg.titleBGMC._width = _loc24_;
         if(bgHeight > 10)
         {
         ...
         this.errorMsg.titleTF._y = _loc15_ - this.errorMsg.titleTF.textHeight - (this.errorMsg.titleTF._height - this.errorMsg.titleTF.textHeight) * 0.5;
         if(txd != undefined && txn != undefined && txd != "" && txn != "")
         {
            ...
            if(imgAlignment == _loc14_)
            {
               ...
               var _loc19_ = this.errorMsg.titleBGMC._alpha;
               this.errorMsg.titleBGMC._alpha = 0;
               com.rockstargames.ui.tweenStar.TweenStarLite.to(this.errorMsg.titleBGMC,com.rockstargames.gtav.utils.GTAVUIConfig.DEFAULT_IMG_FADE_DURATION,{_alpha:_loc19_});
            }
            else if(imgAlignment == _loc18_)
            {
               _loc8_ = 288;
               _loc11_ = 430;
               this.errorImgMC._x = this.errorMsg.tileBGMC.bgMC._width - _loc8_;
               this.errorImgMC._y = 0;
            }
            var _loc22_ = false;
            ...
            this.errorImgMC.init("pause_menu_sp_content",txd,txn,_loc8_,_loc11_);
            if(bRequestTXD)
            {
         ...
         var _loc27_ = new com.rockstargames.ui.utils.Text();
         _loc27_.setTextWithIcons("~HUD_COLOUR_WHITE~" + arguments[3],this.blipLayer,this.errorMsg.bodyTF,0,com.rockstargames.ui.utils.UIText.SIZE,4,false);
         var _loc9_ = this.errorMsg.bodyTF.getTextFormat();
         _loc9_.font = com.rockstargames.gtav.utils.GTAVUIConfig.DEFAULT_FONT;
         _loc9_.size = com.rockstargames.ui.utils.UIText.SIZE;
         this.errorMsg.bodyTF.setTextFormat(_loc9_);
      ...
      {
         var _loc20_ = this.errorMsg._visible;
         var _loc10_ = this.errorMsg.tileBGMC;
         var _loc26_ = _loc10_.col0MC._visible;
         var _loc25_ = _loc10_.col1MC._visible;
         var _loc23_ = _loc10_.col2MC._visible;
         if(_loc20_ && _loc26_ && _loc25_ && _loc23_ && this.menuceptionDepth == 0)
         {
