class com.rockstargames.gtav.hud.hudComponents.HUD_RETICLE extends com.rockstargames.ui.hud.HUD_COMPONENT
{
   ...
   function SET_SCOPE_LOCK(params)
   {
      ...
      {
         if((var _loc0_ = this.weaponID) === this.WEAPON_PROGRAMMABLE_AR)
         {
            var _loc2_ = params[0];
            var _loc3_ = params[1];
   ...
   function SET_RETICLE_POSITION(params)
   {
      ...
      _loc2_.x = _loc2_.x - this.reticleMC._x;
      _loc2_.y = _loc2_.y - this.reticleMC._y;
   ...
   function SET_AIRCRAFT_HUD(params)
   {
      ...
      var _loc8_ = params[1];
      var _loc9_ = 372 * Math.sin(6.283185307179586 * (- _loc10_));
      var _loc3_ = this.getDialAngle(0,360,_loc8_ + 0.5,true);
      if(_loc3_ > 180)
      {
         _loc3_ = _loc3_ - 360;
      }
      var _loc4_ = this.CONTENT.reticleMC.LAZER_HUD.pitch_and_rollMC.PITCH;
      var _loc5_ = this.CONTENT.reticleMC.LAZER_HUD.pitch_and_rollMC;
      _loc4_._y = _loc4_._y + 0.2 * (_loc9_ - _loc4_._y);
      var _loc2_ = _loc3_ - _loc5_._rotation;
      if(_loc2_ < -180)
      {
         _loc2_ = _loc2_ + 360;
      }
      ...
      _loc5_._rotation = _loc5_._rotation + 0.2 * _loc2_;
      var _loc11_ = params[2];
      var _loc12_ = params[3];
      var _loc7_ = 280;
      this.CONTENT.reticleMC.LAZER_HUD.AltitudeScale._y = _loc11_ * 2 * _loc7_;
      this.CONTENT.reticleMC.LAZER_HUD.AirSpeedScale._y = _loc12_ * 2 * _loc7_;
   }
