class com.rockstargames.gtav.hud.hudComponents.HUD_WEAPON_WHEEL extends com.rockstargames.ui.hud.HUD_COMPONENT
{
   ...
   function INITIALISE(mc)
   {
      ...
      this.CONTENT.wheelMC.attachMovie("SLOT_WEAPONS_0","wT0",this.CONTENT.wheelMC.getNextHighestDepth(),{_x:0,_y:-170});
      this.CONTENT.wheelMC.attachMovie("SLOT_WEAPONS_1","wT1",this.CONTENT.wheelMC.getNextHighestDepth(),{_x:116,_y:-112});
      this.CONTENT.wheelMC.attachMovie("SLOT_WEAPONS_2","wT2",this.CONTENT.wheelMC.getNextHighestDepth(),{_x:162,_y:0});
      this.CONTENT.wheelMC.attachMovie("SLOT_WEAPONS_3","wT3",this.CONTENT.wheelMC.getNextHighestDepth(),{_x:116,_y:112});
      this.CONTENT.wheelMC.attachMovie("SLOT_WEAPONS_4","wT4",this.CONTENT.wheelMC.getNextHighestDepth(),{_x:0,_y:162});
      this.CONTENT.wheelMC.attachMovie("SLOT_WEAPONS_5","wT5",this.CONTENT.wheelMC.getNextHighestDepth(),{_x:-116,_y:112});
      this.CONTENT.wheelMC.attachMovie("SLOT_WEAPONS_6","wT6",this.CONTENT.wheelMC.getNextHighestDepth(),{_x:-162,_y:0});
      this.CONTENT.wheelMC.attachMovie("SLOT_WEAPONS_7","wT7",this.CONTENT.wheelMC.getNextHighestDepth(),{_x:-116,_y:-112});
      this.CONTENT.WEAPON_IN_CAR.attachMovie("MASTER_WEAPONS","wT8",this.CONTENT.WEAPON_IN_CAR.getNextHighestDepth());
      this.CONTENT.wheelMC.wT0.attachMovie("AMMO_MASTER","ammoMC",this.CONTENT.wheelMC.wT0.getNextHighestDepth(),{_x:-2,_y:34});
      this.CONTENT.wheelMC.wT1.attachMovie("AMMO_MASTER","ammoMC",this.CONTENT.wheelMC.wT1.getNextHighestDepth(),{_x:20,_y:37});
      this.CONTENT.wheelMC.wT2.attachMovie("AMMO_MASTER","ammoMC",this.CONTENT.wheelMC.wT2.getNextHighestDepth(),{_x:-9,_y:46});
      this.CONTENT.wheelMC.wT3.attachMovie("AMMO_MASTER","ammoMC",this.CONTENT.wheelMC.wT3.getNextHighestDepth(),{_x:-15,_y:35});
      this.CONTENT.wheelMC.wT4.attachMovie("AMMO_MASTER","ammoMC",this.CONTENT.wheelMC.wT4.getNextHighestDepth(),{_x:-5,_y:52});
      this.CONTENT.wheelMC.wT5.attachMovie("AMMO_MASTER","ammoMC",this.CONTENT.wheelMC.wT5.getNextHighestDepth(),{_x:12,_y:35});
      this.CONTENT.wheelMC.wT6.attachMovie("AMMO_MASTER","ammoMC",this.CONTENT.wheelMC.wT6.getNextHighestDepth(),{_x:-3,_y:46});
      this.CONTENT.wheelMC.wT7.attachMovie("AMMO_MASTER","ammoMC",this.CONTENT.wheelMC.wT7.getNextHighestDepth(),{_x:-12,_y:37});
      this.CONTENT.WEAPON_IN_CAR.wT8.attachMovie("AMMO_MASTER","ammoMC",this.CONTENT.WEAPON_IN_CAR.wT8.getNextHighestDepth(),{_y:65});
   ...
   function setWeaponLabelAndPage()
   {
      ...
      if(_loc2_ != undefined)
      {
         var _loc3_ = this.slotIndexList[this.weaponTypeIndex].index;
   ...
   function highlightWeapon()
   {
      ...
      while(_loc2_ < 8)
      {
         var _loc3_ = this.CONTENT.wheelMC["s" + _loc2_ + "MC"];
   ...
   function setSlotHighlight(i, slotMC, bHighlight)
   {
      ...
      if(this.enable3D)
      {
         var _loc5_ = 0.7853981633974483 * i - 1.5707963267948966;
         if(this.b3DTest == 1)
         {
            var _loc8_ = !bHighlight?158:164;
            var _loc10_ = Math.cos(_loc5_) * _loc8_;
            var _loc9_ = Math.sin(_loc5_) * _loc8_;
            var _loc12_ = !bHighlight?100:125;
            var _loc11_ = !bHighlight?100:125;
         ...
         else if(this.b3DTest == 2)
         {
            if(bHighlight)
            {
               ...
               {
                  var _loc20_ = 0.7853981633974483 * i - 1.5707963267948966;
                  if(i > 0 && i < 4)
                  {
   ...
   function SET_PLAYER_WEAPON_WHEEL(params)
   {
      ...
      if(_loc3_ != com.rockstargames.gtav.constants.WeaponsLUT.WEAPON_INVALID)
      {
         ...
         var _loc6_ = this.slotList[_loc2_];
         if(_loc6_ == undefined)
         {
   ...
   {
      var _loc3_ = weaponData[this.ARG_WEAPON_EQUIPPED];
      var _loc4_ = !this._isInCar?this.CONTENT.wheelMC["s" + slotTypeIndex + "MC"]:this.CONTENT.WEAPON_IN_CAR;
      _loc4_.outlineMC._visible = !_loc3_;
      _loc4_.outlineHighlightMC._visible = _loc3_;
      if(_loc3_ && this._HUD.charColourEnum)
      {
         com.rockstargames.ui.utils.Colour.ApplyHudColour(_loc4_.outlineHighlightMC,this._HUD.charColourEnum);
      }
      ...
      var _loc5_ = !this._isInCar?this.CONTENT.wheelMC["wT" + slotTypeIndex]:this.CONTENT.WEAPON_IN_CAR.wT8;
      _loc5_._alpha = !_loc8_?30:100;
      var _loc11_ = _loc5_.ammoMC;
      _loc5_.gotoAndStop("INT" + _loc7_);
      if(_loc6_ != undefined && _loc9_ != undefined)
      {
         _loc11_.SET_AMMO_COUNT([_loc6_,_loc9_,_loc10_,_loc7_]);
      }
   }
   function cycleWeapons(dir)
   {
      if(this.canCycle)
      {
         ...
         if(_loc4_ != undefined)
         {
            ...
            if(_loc3_ > 1)
            {
               var _loc6_ = this.slotIndexList[this.weaponTypeIndex].index;
               var _loc2_ = _loc6_;
               if(dir > 0)
               {
   ...
   function SET_POINTER(params)
   {
      ...
      else
      {
         if(this.oldweaponTypeIndex != this.weaponTypeIndex)
         {
            ...
            var _loc5_ = this.slotList[this.weaponTypeIndex];
            if(_loc5_ != undefined)
            {
               var _loc6_ = this.slotIndexList[this.weaponTypeIndex].index;
   ...
   function SHOW()
   {
      ...
      while(_loc2_ < 9)
      {
         var _loc4_ = this.slotIndexList[_loc2_];
         if(_loc4_ != undefined)
         {
            var _loc6_ = _loc4_.index;
            var _loc3_ = this.slotList[_loc2_][_loc6_].data;
            var _loc7_ = _loc3_[0];
            var _loc8_ = _loc3_[3];
            if(_loc8_)
            {
         ...
         {
            var _loc5_ = this.CONTENT.wheelMC["s" + _loc2_ + "MC"];
