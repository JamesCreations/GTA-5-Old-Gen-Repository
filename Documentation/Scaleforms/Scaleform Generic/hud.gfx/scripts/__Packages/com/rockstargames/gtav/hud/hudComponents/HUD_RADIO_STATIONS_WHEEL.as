class com.rockstargames.gtav.hud.hudComponents.HUD_RADIO_STATIONS_WHEEL extends com.rockstargames.ui.hud.HUD_COMPONENT
{
   ...
   function INITIALISE(mc)
   {
      ...
      _loc2_.setTextWithIcons("RADIO_SHARE",this.blipLayer,this.shareTF,6,12,2,false,true);
      ...
      _loc2_.setTextWithIcons("RADIO_SHARE",this.blipLayerOutline,this.shareTFOutline,6,12,2,false,true);
      ...
      this.blipLayer._y = this.blipLayerOutline._y = this.blipLayer._y + 9;
