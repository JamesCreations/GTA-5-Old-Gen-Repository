class com.rockstargames.gtav.Multiplayer.MP_MM_CARD_FREEMODE extends com.rockstargames.gtav.levelDesign.BaseScriptUI
{
   ...
   {
      super.INITIALISE(mc);
      this.CONTENT._x = this.CONTENT._x + 25;
      this.dataList = [];
      this.itemList = [];
   ...
   function UPDATE_SLOT(_viewIndex)
   {
      ...
      if(_loc3_ != undefined)
      {
         (com.rockstargames.gtav.Multiplayer.items.MPMMFreemodeItem)_loc3_.__set__data(arguments);
      }
   }
   function DISPLAY_VIEW()
   {
      ...
      while(_loc3_ < this.dataList.length)
      {
         ...
         _loc2_._x = -25;
         (com.rockstargames.gtav.Multiplayer.items.MPMMFreemodeItem)_loc2_.__set__data(_loc5_);
