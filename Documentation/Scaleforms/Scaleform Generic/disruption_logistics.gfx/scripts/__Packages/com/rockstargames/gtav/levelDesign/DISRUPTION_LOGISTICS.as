class com.rockstargames.gtav.levelDesign.DISRUPTION_LOGISTICS extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function updateButtons()
   {
      if(this.overlay.__get__isShowing())
      {
         this.cursor.setTargetRects(this.overlay.__get__buttons());
      }
      else if(this.currScreen)
      {
         this.cursor.setTargetRects(this.currScreen.__get__buttons().concat(this.navigationPanel.__get__buttons()));
      }
      else
      {
         this.cursor.setTargetRects(this.navigationPanel.__get__buttons());
      }
   }
