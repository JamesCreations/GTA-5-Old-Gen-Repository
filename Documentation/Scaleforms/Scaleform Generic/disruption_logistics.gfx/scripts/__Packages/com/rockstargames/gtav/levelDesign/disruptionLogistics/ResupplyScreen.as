class com.rockstargames.gtav.levelDesign.disruptionLogistics.ResupplyScreen extends com.rockstargames.gtav.levelDesign.disruptionLogistics.Screen
{
   ...
   {
      super.update();
      this.buyButton.__set__state(this.app.resupplyButtonState);
      this.stealButton.__set__state(this.app.stealButtonState);
      if(this.app.resupplyButtonState == com.rockstargames.gtav.levelDesign.disruptionLogistics.Button.ACTIVE)
      {
         if(this.app.resupplySaleCost >= 0)
         {
            ...
            this.view.buySuppliesButton.label.text = this.view.buySuppliesButton.label.text + (" $" + com.rockstargames.gtav.levelDesign.DISRUPTION_LOGISTICS.formatNumber(this.app.resupplySaleCost));
            this.view.buySuppliesButton.line._x = this.view.buySuppliesButton.line._x - 0.5 * (this.view.buySuppliesButton.label.textWidth - _loc3_);
