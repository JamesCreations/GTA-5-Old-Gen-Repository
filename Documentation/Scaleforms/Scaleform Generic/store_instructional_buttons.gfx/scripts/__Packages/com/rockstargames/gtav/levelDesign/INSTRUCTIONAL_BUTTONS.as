class com.rockstargames.gtav.levelDesign.INSTRUCTIONAL_BUTTONS extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   {
      this.MOUSE_EVT.triggerEvent(_inputID,this.MOUSE_EVT.MOUSE_RELEASE);
   }
   ...
   function generateTextField(textFieldName, textString, parentMovieClip)
   {
      ...
      if(textString != undefined)
      {
         ...
         this.parseForGamerName(_loc3_,textString);
      }
   ...
   function debug()
   {
      ...
      this.SET_DATA_SLOT(0,"b_31","Transitioning to <C>Cheesewhisk</C> lobby",0,-1);
      this.SET_DATA_SLOT(1,"b_30","Vote",0,-1);
      this.SET_DATA_SLOT(2,"t_D%t_S%t_A%t_W","Move",1,56);
      this.SET_DATA_SLOT(3,"b_32","b_33","Player List",1,78);
