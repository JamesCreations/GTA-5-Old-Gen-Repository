class com.rockstargames.gtav.Multiplayer.MP_BIG_MESSAGE_FREEMODE extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function createMessageNG(linkageID, args)
   {
      ...
      while(_loc2_ < _loc8_.length)
      {
         if(_loc3_.indexOf(_loc8_.charAt(_loc2_)) != -1)
         {
            ...
            this.BigMessageMaster.BIG_TEXT_WRAPPER._y = this.BigMessageMaster.BIG_TEXT_WRAPPER._y - _loc4_;
            break;
         }
         _loc2_ = _loc2_ + 1;
      }
      ...
      if(_loc6_)
      {
         ...
         _loc10_._y = _loc10_._y - 10;
         var _loc11_ = _loc10_.getNewTextFormat();
         _loc11_.size = _loc11_.size * 0.85;
   ...
   function SHOW_CREW_RANKUP_MP_MESSAGE(titleStr, msgStr, rankNumber, emblemTXD, emblemTXN, alpha)
   {
      ...
      if(msgStr != "" && msgStr != undefined)
      {
         ...
         _loc2_ = _loc2_ + (this.BigMessageMaster.CREW_RANK_ICON._width + 10);
      }
   ...
   function SHOW_MISSION_PASSED_MESSAGE()
   {
      if(arguments.length >= 5)
      {
         ...
         if(arguments[1] && arguments[1] != "")
         {
            ...
            this.bigTextGoalY = this.bigTextGoalY - this.BigMessageMaster.BIG_TEXT_WRAPPER._y;
         }
      }
      else
      {
   ...
   function SHOW_BIG_MP_MESSAGE_WITH_STRAP_AND_RANK()
   {
      ...
      _loc3_ = _loc3_ + Math.min(this.STRAP_MSG_DELAY_DURATION,this.STRAP_MSG_DURATION);
      _loc3_ = _loc3_ + (Math.max(this.STRAP_MSG_DELAY_DURATION,this.STRAP_MSG_DURATION) - Math.min(this.STRAP_MSG_DELAY_DURATION,this.STRAP_MSG_DURATION));
      return _loc3_ * 1000;
   }
   ...
   function SHOW_BIG_MP_MESSAGE()
   {
      ...
      if(_loc6_ != undefined)
      {
         _loc4_ = _loc4_ + Math.min(this.STRAP_MSG_DELAY_DURATION,this.STRAP_MSG_DURATION);
         _loc4_ = _loc4_ + (Math.max(this.STRAP_MSG_DELAY_DURATION,this.STRAP_MSG_DURATION) - Math.min(this.STRAP_MSG_DELAY_DURATION,this.STRAP_MSG_DURATION));
   ...
   {
      var _loc3_ = arguments[2];
      this.DO_SHARD(arguments,true,_loc3_);
   }
   ...
   function DO_SHARD(args, isCenter, colID, shardColID, useLargeShard)
   {
      ...
      var _loc8_ = !useLargeShard?"SHARD_MESSAGE":"SHARD_MESSAGE_LARGE";
      this.BigMessageMaster = this.CONTENT.attachMovie(_loc8_,"SHARD_MESSAGE",this.ENFORCED_DEPTH,{_x:640});
      var _loc14_ = !isCenter?116:324;
      this.BigMessageMaster.textHolderMC._y = _loc14_;
      this.SHARD_SET_TEXT(_loc4_,_loc5_,colID);
      ...
      {
         if(_loc4_.charCodeAt(_loc2_) > 11263)
         {
            _loc3_ = true;
            break;
         }
      ...
      if(_loc3_)
      {
         var _loc6_ = this.BigMessageMaster.textHolderMC.titleMC.BIG_TEXT;
         _loc6_._y = _loc6_._y - 10;
         var _loc7_ = _loc6_.getNewTextFormat();
         _loc7_.size = _loc7_.size * 0.85;
         _loc6_.setTextFormat(_loc7_);
         _loc6_ = this.BigMessageMaster.textHolderMC.coltitleMC.BIG_TEXT;
         _loc6_._y = _loc6_._y - 10;
         _loc7_ = _loc6_.getNewTextFormat();
         _loc7_.size = _loc7_.size * 0.85;
         _loc6_.setTextFormat(_loc7_);
      }
      var _loc10_ = 30;
      ...
      {
         var _loc13_ = 8;
         var _loc12_ = 360 - _loc13_;
         this.BigMessageMaster.bgMC._y = _loc12_;
   ...
   function SHARD_SET_TEXT(bigText, msgText, colID)
   {
      ...
      else
      {
         ...
         if(_loc8_._visible == true)
         {
            ...
            _loc9_._y = _loc9_._y - _loc10_;
            _loc8_._y = _loc8_._y - _loc10_;
            _loc3_._y = _loc3_._y - _loc10_;
         }
   ...
   function TRANSITION_OUT(duration)
   {
      ...
      com.rockstargames.ui.tweenStar.TweenStarLite.removeTweenOf(this.BigMessageMaster.textHolderMC.titleMC);
      com.rockstargames.ui.tweenStar.TweenStarLite.removeTweenOf(this.BigMessageMaster.textHolderMC.coltitleMC);
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.BigMessageMaster,duration,{_alpha:-40,Ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN,_y:- this.BigMessageMaster._height});
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.BigMessageMaster.BIG_TEXT_OUTLINE,duration * 0.75,{_alpha:0,Ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN});
   }
