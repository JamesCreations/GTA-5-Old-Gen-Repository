   ...
   function __set__data(_d)
   {
      ...
      switch(this.type)
      {
         ...
         case com.rockstargames.gtav.levelDesign.GAME_STREAM_ENUMS.TICKER:
            ...
            this.textIconLayerMC._y = 3;
            var _loc11_ = new com.rockstargames.ui.utils.Text();
            _loc11_.setTextWithIcons(this.type != com.rockstargames.gtav.levelDesign.GAME_STREAM_ENUMS.TICKER?this.bodyMC.bodyTF.text:this.bodyMC.bodyTF.htmlText,this.textIconLayerMC,this.bodyMC.bodyTF,0,13,3,false);
            break;
