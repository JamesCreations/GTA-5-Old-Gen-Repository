class com.rockstargames.gtav.pauseMenuPages.PAUSE_MENU_PAGES_CREWS extends com.rockstargames.gtav.pauseMenuPages.PauseMenuBasePage
{
   ...
   function setupPage()
   {
      ...
      this.colCrewListMid = this.addColumn("crewsList",2,290);
      this.colCrewCard = this.addColumn("crewsCard",3,580);
      this.colCrewRanks = this.addColumn("crewRanks",7,580);
      ...
      this.setupColScroll([this.colCrewListLeft,this.colCrewListMid,this.colCrewCard,this.colFriendsList,this.colPlayerModel,this.colCrewRanks,this.colCrewCompare1,this.colCrewCompare2],[true,true,false,false,false,false,false,false]);
