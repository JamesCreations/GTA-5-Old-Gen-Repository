   ...
   function populateContent()
   {
      ...
      if(this.dataProviderUI.length > 0)
      {
         if(this.dataProviderUI[0][7] == true)
         {
            ...
            {
               _loc3_ = _loc3_ + (this.dataProviderUI[_loc2_][0] + "<br/>");
               _loc2_ = _loc2_ + 1;
            }
            _loc3_ = _loc3_ + ("<br/>" + _loc4_ + "<br/>");
         }
         else
         {
            _loc2_ = 0;
            while(_loc2_ < this.dataProviderUI.length)
            {
               ...
               if(_loc2_ > 0)
               {
                  _loc3_ = _loc3_ + (_loc10_ + "<br/><br/>" + _loc5_ + _loc11_ + "<br/>" + _loc8_ + "<br/>" + _loc9_ + "<br/>");
               ...
               _loc3_ = _loc3_ + (this.messageBody + "<br/>");
               _loc3_ = _loc3_ + ("<br/>" + _loc4_ + "<br/>");
