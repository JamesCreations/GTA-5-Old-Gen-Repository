class com.rockstargames.gtav.pc.applications.hacking.BruteForceApp extends com.rockstargames.gtav.pc.applications.hacking.BaseHacking
{
   ...
   {
      var _loc2_ = this.__get__rouletteIndex() + vx;
      if(_loc2_ < 0)
      {
      ...
      this.__set__rouletteIndex(_loc2_);
   ...
   {
      var _loc6_ = this.rouletteColItems[this.__get__rouletteIndex()];
   ...
   function jumpHighlight()
   {
      ...
      {
         var _loc2_ = this.__get__rouletteIndex() + _loc3_ + 1;
         if(_loc2_ > this.rouletteColumns - 1)
         {
            _loc2_ = _loc2_ - this.rouletteColumns;
         }
         _loc5_ = _loc5_ - 1;
         var _loc4_ = this.rouletteColItems[_loc2_];
         if(!_loc4_.success)
   ...
   function __get__rouletteIndex()
   {
      return this._rouletteIndex;
   }
   function __set__rouletteIndex(r)
   {
      ...
      {
         var _loc3_ = this.rouletteColItems[_loc2_];
         _loc3_.__set__highlighted(Boolean(_loc2_ == this._rouletteIndex));
         _loc2_ = _loc2_ + 1;
      }
      return this.__get__rouletteIndex();
   }
