class com.rockstargames.gtav.store.STORE_DETAILS_LIST extends com.rockstargames.gtav.store.EcommerceStoreBaseClass
{
   ...
   function REDRAW()
   {
      ...
      {
         this.textTF.htmlText = this.textTF.htmlText + this.parseLinebreaks(this.data[1].toString());
         _loc2_ = false;
      }
      else
      {
      ...
      {
         _loc4_ = _loc4_.split("MSP").join("<img src=\'points_icon\' height=\'16\' width=\'16\'>");
         this.PriceItemMC.labelMC.priceTF.html = true;
         this.PriceItemMC.labelMC.priceTF.autoSize = true;
         this.PriceItemMC.labelMC.priceTF.htmlText = _loc4_;
         _loc7_ = true;
      }
      if(_loc3_ == undefined || _loc3_ == 0 || _loc3_ == "0" || _loc3_ == "")
      {
      ...
      else
      {
         ...
         this.PriceItemMC.playersMC.playersTF.text = _loc3_;
