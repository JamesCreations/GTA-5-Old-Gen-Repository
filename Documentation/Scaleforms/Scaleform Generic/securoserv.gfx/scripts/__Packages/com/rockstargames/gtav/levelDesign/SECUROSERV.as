class com.rockstargames.gtav.levelDesign.SECUROSERV extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function SET_PLAYER_DATA(gamerTag, gamerHasAccess, totalEarnings, collectionsCompleted, collectionSuccessRate, salesCompleted, salesSuccessRate, organisation, numVehiclesStolen, stealVehiclesSuccess, vehiclesExported, exportVehiclesSuccess, totalVehicleEarnings, hasSpecialVehicleMissions, playerX, playerY)
   {
      ...
      {
         (com.rockstargames.gtav.levelDesign.securoserv.LoginScreen)this.currScreen.__set__userName(gamerTag);
      }
   }
   ...
   {
      var _loc2_ = this.currScreenID == this.MAP_SCREEN && (com.rockstargames.gtav.levelDesign.securoserv.MapScreen)this.currScreen.__get__warehousePanelShowing();
      var _loc3_ = this.currScreenID == this.IMPORT_EXPORT_MAP_SCREEN && (com.rockstargames.gtav.levelDesign.securoserv.ImportExportMapScreen)this.currScreen.__get__warehousePanelShowing();
