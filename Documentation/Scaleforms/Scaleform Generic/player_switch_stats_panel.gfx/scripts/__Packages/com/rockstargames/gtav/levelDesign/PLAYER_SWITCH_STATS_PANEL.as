class com.rockstargames.gtav.levelDesign.PLAYER_SWITCH_STATS_PANEL extends com.rockstargames.gtav.levelDesign.BaseScriptUI
{
   ...
   function SET_STATS_LABELS(charColourEnum)
   {
      ...
      {
         var _loc3_ = this.panelMC["statMC" + _loc5_];
         ...
         var _loc6_ = _loc5_ < _loc14_;
         var _loc10_ = _loc3_.nameTF;
         var _loc7_ = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.PauseMenuColourBar)_loc3_.statBar;
