class com.rockstargames.gtav.levelDesign.securoserv.WarehouseImageManager
{
   ...
   {
      if(com.rockstargames.gtav.levelDesign.securoserv.WarehouseImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == "loaded")
      {
      ...
      else
      {
         ...
         {
            com.rockstargames.ui.game.GameInterface.call("REQUEST_TXD_AND_ADD_REF",com.rockstargames.ui.game.GameInterface.GENERIC_TYPE,"WAREHOUSE",txd,id,true);
   ...
   function dispose()
   {
      ...
      {
         com.rockstargames.ui.game.GameInterface.call("REMOVE_TXD_REF",com.rockstargames.ui.game.GameInterface.GENERIC_TYPE,"WAREHOUSE",_loc2_);
      }
   }
}
