class com.rockstargames.gtav.levelDesign.DashboardDials.AIRCRAFT_DIALS extends com.rockstargames.gtav.levelDesign.BaseScriptUI
{
   ...
   function SET_DASHBOARD_DIALS(fuel, temp, oilPressure, battery, fuelPSI, airSpeed, verticleAirSpeed, compass, roll, pitch, alt_small, alt_large)
   {
      ...
      this.CONTENT.DIALS.compass_dialMC._rotation = this.getDialAngle(360,0,compass + 0.5,false);
      this.CONTENT.DIALS.pitch_dialMC.INDICATOR._y = 27 * Math.sin(6.283185307179586 * (- pitch)) * -1;
      this.CONTENT.DIALS.roll_dialMC._rotation = this.getDialAngle(360,0,roll + 0.5,true);
   }
   function SET_DASHBOARD_LIGHTS(gearUp, gearDown)
   {
   ...
   function debug()
   {
      ...
      this.SET_DASHBOARD_LIGHTS(false,true);
