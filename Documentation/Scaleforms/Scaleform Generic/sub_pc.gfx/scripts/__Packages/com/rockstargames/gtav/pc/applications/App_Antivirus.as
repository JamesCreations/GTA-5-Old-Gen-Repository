class com.rockstargames.gtav.pc.applications.App_Antivirus extends com.rockstargames.gtav.pc.applications.App_Base
{
   ...
   function ready(fText)
   {
      ...
      if(!this.isWindowOpen)
      {
         ...
         this.__get__desktopRef().addButtons(this.actionBtn,true);
         ...
         this.__get__desktopRef().addButtons(this.windowBtn,true);
      }
   }
   ...
   {
      this.__get__desktopRef().removeButtons(this.actionBtn);
   ...
   {
      this.__get__desktopRef().removeButtons(this.actionBtn);
      this.__get__desktopRef().removeButtons(this.windowBtn);
      this.__get__desktopRef().resetUnderCursor();
      this._visible = this.isWindowOpen = false;
   }
   function startDebug()
