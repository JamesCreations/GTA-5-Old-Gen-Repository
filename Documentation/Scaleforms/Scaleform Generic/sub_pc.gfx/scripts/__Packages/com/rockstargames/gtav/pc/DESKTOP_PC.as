class com.rockstargames.gtav.pc.DESKTOP_PC extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function getKeys()
   {
      ...
      {
         this.scanpercent = this.scanpercent + 1;
   ...
   function SET_DISPLAY_CONFIG(_screenWidthPixels, _screenHeightPixels, _safeTopPercent, _safeBottomPercent, _safeLeftPercent, _safeRightPercent, _isWideScreen, _isHiDef)
   {
      ...
      this.safeLeft = _loc3_ + _safeLeftPercent * _screenWidthPixels;
      this.safeRight = _loc3_ + _safeRightPercent * _screenWidthPixels;
      this.safeTop = _loc2_ + _safeTopPercent * _screenHeightPixels;
      this.safeBottom = _loc2_ + _safeBottomPercent * _screenHeightPixels;
   ...
   function testList(list)
   {
      ...
      if(_loc5_)
      {
         ...
         this.buttonUnderCursor.__set__highlight(false);
         this.buttonUnderCursor = _loc6_;
         this.buttonUnderCursor.__set__highlight(true);
      ...
      switch(i)
      {
         case com.rockstargames.gtav.constants.PCAppLUT.PC_ANTIVIRUS[0]:
            if(this.antivirusApp == undefined)
            {
               ...
               this.antivirusApp.__set__desktopRef(this);
            }
            break;
         case com.rockstargames.gtav.constants.PCAppLUT.PC_VIRUS[0]:
            if(this.popupApp == undefined)
            {
               ...
               this.popupApp.__set__desktopRef(this);
               ...
               this.popupApp.__set__data(this.popupData);
               this.popupApp.ready();
            }
      }
   }
   ...
   {
      if((var _loc0_ = id) !== com.rockstargames.gtav.constants.PCAppLUT.PC_VIRUS[0])
      {
      }
   }
