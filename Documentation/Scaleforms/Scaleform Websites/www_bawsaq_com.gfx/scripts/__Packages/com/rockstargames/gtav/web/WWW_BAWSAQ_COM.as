class com.rockstargames.gtav.web.WWW_BAWSAQ_COM extends com.rockstargames.ui.core.BaseWebsite
{
   ...
   function POPULATE_TEXT(pageName)
   {
      ...
      switch(pageName)
      {
         case "PAGE1":
            ...
            this.mcScope.poweredBySC.header.autoSize = "left";
            this.mcScope.poweredBySC.header.wordWrap = true;
            this.mcScope.poweredBySC.header.isHTML = true;
            com.rockstargames.ui.utils.Localisation.setTextWithTranslation(this.mcScope.poweredBySC.header,"BS_WB_SOCIAL_CLUB",undefined,true);
            if(this.mcScope.poweredBySC.header._height + 20 > 58)
            {
               this.mcScope.poweredBySC.bg._height = this.mcScope.poweredBySC.header._height + 20;
            }
            var _loc11_ = new Array("headerNews_bar","newsItem1","newsItem2","newsItem3","poweredBySC");
   ...
   function setAndPositionLogo(companyAbv)
   {
      ...
      {
         _loc2_ = _loc2_ * (_loc4_ / this.mcScope.companyLogo._width);
         this.mcScope.companyLogo._xscale = this.mcScope.companyLogo._yscale = _loc2_;
      }
