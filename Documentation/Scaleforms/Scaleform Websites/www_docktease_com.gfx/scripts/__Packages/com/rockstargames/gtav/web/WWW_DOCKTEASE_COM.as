class com.rockstargames.gtav.web.WWW_DOCKTEASE_COM extends com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT
{
   ...
   function filterVehicles()
   {
      if(this.isMP)
      {
         ...
         this.vehicles = {DOCK_BOATS:[this.vehicles.TUG,this.vehicles.TORO,this.vehicles.SUB2,this.vehicles.DINGHY3,this.vehicles.SPEEDER,this.vehicles.MARQUIS,this.vehicles.JETMAX,this.vehicles.SQUALO,this.vehicles.SUNTRAP,this.vehicles.TROPIC,this.vehicles.SEASHARK]};
   ...
   function initBuyItNowDetailsPage(id, currentVehicle, newPage, frame)
   {
      ...
      if(currentVehicle.secondaryPrice > 0)
      {
         ...
         var _loc6_ = _loc2_.BUYITNOWSTOCK_2._width;
         if(currentVehicle.secondarySalePrice != undefined && currentVehicle.secondarySalePrice > 0 && currentVehicle.secondarySalePrice != currentVehicle.secondaryPrice)
         {
            ...
            var _loc7_ = _loc2_.BUYITNOWSTOCK_2.originalPriceText.textWidth + _loc2_.BUYITNOWSTOCK_2.priceText.textWidth + 10;
      ...
      {
         _loc4_ = _loc4_ + (_loc2_.BUYITNOWSTOCK_1._height + 18);
      }
      if(_loc2_.BUYITNOWSTOCK_2._visible)
      {
         _loc2_.BUYITNOWSTOCK_2._y = _loc4_;
         _loc4_ = _loc4_ + (_loc2_.BUYITNOWSTOCK_2._height + 18);
      }
      _loc2_.descriptionText._y = _loc4_;
      _loc4_ = _loc4_ + (_loc2_.descriptionText._height + 16);
      if(_loc2_.options._visible)
      {
         _loc2_.optionsHeaderText._y = _loc4_;
         _loc4_ = _loc4_ + _loc2_.optionsHeaderText._height;
         _loc2_.options._y = _loc4_;
         _loc4_ = _loc4_ + _loc2_.options._height;
      }
      var _loc5_ = 0;
      if(_loc4_ > _loc2_.subHeader._y)
      {
         _loc5_ = _loc4_ - _loc2_.subHeader._y;
         _loc2_.subHeader._y = _loc2_.subHeader._y + _loc5_;
         _loc2_.priceSortButton._y = _loc2_.priceSortButton._y + _loc5_;
         _loc2_.filterDropDown._y = _loc2_.filterDropDown._y + _loc5_;
      }
   ...
   function goToYachtFlagAnchor(attribute)
   {
      ...
      if(this.yachtFlag != -1)
      {
         _loc4_ = _loc4_ + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_COST];
      ...
      {
         _loc4_ = _loc4_ + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_COST];
         ...
         {
            _loc3_ = _loc3_ + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_COST];
         }
      }
   ...
   function initHomePage(newPage)
   {
      ...
      if(_loc6_)
      {
         ...
         {
            var _loc8_ = 236;
            var _loc7_ = _loc4_.panel._y + 20;
            var _loc5_ = _loc4_.attachMovie("yachtBannerButton",com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.YACHT_HOME_PAGE,_loc4_.getNextHighestDepth(),{_x:_loc8_,_y:_loc7_});
            ...
            var _loc9_ = this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_COLOUR] + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_LIGHTING] + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG] + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_MODEL] + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FITTINGS] != -5;
            if(_loc9_)
            {
   ...
   function initYachtHomePage(newPage)
   {
      ...
      if(newPage)
      {
         ...
         {
            var _loc6_ = this.customVehicles.YACHTS[_loc4_];
            var _loc5_ = "yachtStart_" + _loc6_.id;
            var _loc3_ = _loc2_.attachMovie("yachtHomepageButton",_loc5_,_loc2_.getNextHighestDepth());
   ...
   function getCheapestModification()
   {
      ...
      {
         var _loc5_ = this.yachtData[_loc6_[_loc3_]];
         if(_loc5_ < _loc4_)
         {
            _loc4_ = _loc5_;
         }
         var _loc2_ = this.yachtData[_loc7_[_loc3_]];
   ...
   {
      var _loc2_ = 0;
      _loc2_ = _loc2_ + this.getCheapestValidPrice(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_COST],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_SALE_COST]);
      _loc2_ = _loc2_ + this.getCheapestValidPrice(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_COST],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_SALE_COST]);
      _loc2_ = _loc2_ + this.getLowestValueInArray(this.yachtData,com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_MODEL_COST.concat(com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_MODEL_SALE_COST));
      _loc2_ = _loc2_ + this.getLowestValueInArray(this.yachtData,com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FITTINGS_COST.concat(com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FITTINGS_SALE_COST));
      _loc2_ = _loc2_ + this.getLowestValueInArray(this.yachtData,com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_LIGHTING_COST.concat(com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_LIGHTING_SALE_COST));
      _loc2_ = _loc2_ + this.getLowestValueInArray(this.yachtData,com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_COLOUR_COST.concat(com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_COLOUR_SALE_COST));
      return _loc2_;
   }
   function getLowestValueInArray(array, indexes)
   {
      ...
      {
         var _loc1_ = array[indexes[_loc2_]];
   ...
   function initYachtModelPage(newPage)
   {
      ...
      if(newPage || !this.currentPageInitialised)
      {
         ...
         if(_loc2_.disclaimer.textHeight > 62)
         {
            ...
            var _loc3_ = _loc2_.disclaimer.getTextFormat();
   ...
   function initModelDropDown(page)
   {
      ...
      while(_loc2_ < _loc4_)
      {
         var _loc3_ = this.filterDropDown.addItem(this.currentVehicle.models[_loc2_]);
   ...
   function initFittingsDropDown(page)
   {
      ...
      while(_loc2_ < _loc4_)
      {
         var _loc3_ = this.filterDropDown.addItem(this.currentVehicle.fittings[_loc2_]);
   ...
   function initLightingButtons(page)
   {
      ...
      while(_loc2_ < _loc4_)
      {
         var _loc3_ = page.options["yachtLightingButton_" + _loc2_];
   ...
   function initColourButtons(page)
   {
      ...
      while(_loc2_ < _loc4_)
      {
         var _loc3_ = page.options["yachtColourButton_" + _loc2_];
         _loc3_.swatch.gotoAndStop(_loc2_ + 2);
         this.dataTextScope.push(_loc3_.btnTxt);
         _loc2_ = _loc2_ + 1;
      }
   ...
   function initYachtPersonalisePage(newPage)
   {
      ...
      if(newPage || !this.currentPageInitialised)
      {
         ...
         this.dataTextScope.push(_loc2_.WWW_DOCKTEASE_COM.btnTxt);
         var _loc7_ = !this.isModifying || this.yachtModel + this.yachtFittings + this.yachtLighting + this.yachtColour + this.yachtFlag == -5 && this.yachtName == "";
      ...
      if(this.yachtData)
      {
         ...
         if(this.yachtFlag != -1)
         {
            _loc5_ = _loc5_ + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_COST];
            if(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_SALE_COST] != undefined && this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_SALE_COST] > 0)
            {
               _loc3_ = this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_SALE_COST];
            }
         ...
         if(this.yachtName != "" && this.yachtName != this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME])
         {
            _loc5_ = _loc5_ + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_COST];
            if(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_SALE_COST] != undefined && this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_SALE_COST] > 0)
            {
               if(_loc3_ == undefined)
               {
         ...
         this.updateUpgradeTotal(_loc2_.tabs.YACHT_D_CHECKOUT.cost);
         var _loc6_ = this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME];
   ...
   function initFlagButtons(page)
   {
      ...
      while(_loc2_ < _loc4_)
      {
         var _loc3_ = page.options["yachtFlagButton_" + _loc2_];
         _loc3_.swatch.gotoAndStop(_loc2_ + 2);
         this.dataTextScope.push(_loc3_.btnTxt);
         _loc2_ = _loc2_ + 1;
      }
   ...
   function pollYachtNameChange(page)
   {
      ...
      {
         this.yachtData = this.dataProviderUI[this.currentVehicle.id];
         var _loc10_ = this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME];
         var _loc4_ = this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NEW_NAME];
         this.yachtName = _loc4_;
         var _loc6_ = 0;
         var _loc3_ = undefined;
         if(this.yachtFlag != -1)
         {
            _loc6_ = _loc6_ + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_COST];
            if(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_SALE_COST] != undefined && this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_SALE_COST] > 0)
            {
               _loc3_ = this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_SALE_COST];
            }
         ...
         if(this.yachtName != "" && this.yachtName != this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME])
         {
            _loc6_ = _loc6_ + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_COST];
            if(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_SALE_COST] != undefined && this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_SALE_COST] > 0)
            {
               if(_loc3_ != undefined)
               {
                  _loc3_ = _loc3_ + this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_SALE_COST];
               }
               else
               {
                  _loc3_ = this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_SALE_COST];
         ...
         var _loc5_ = page.yachtSetNameButton.btnTxt;
         if(_loc4_ != "")
         {
            _loc5_.text = _loc4_;
   ...
   function initYachtCheckoutPage(newPage)
   {
      ...
      if(newPage)
      {
         ...
         var _loc4_ = this.initTotalPrice(_loc2_.price);
         if(this.isModifying && _loc4_ == 0)
         {
   ...
   function initYachtPurchasePage(newPage)
   {
      ...
      if(newPage)
      {
         ...
         var _loc3_ = this.yachtModel != -1?this.yachtModel:this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_MODEL];
   ...
   function getTotalPrice(includeBaseCost)
   {
      ...
      if(this.yachtModel != -1)
      {
         _loc2_ = _loc2_ + this.getCheapestValidPrice(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_MODEL_COST[this.yachtModel]],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_MODEL_SALE_COST[this.yachtModel]]);
      }
      if(this.yachtFittings != -1)
      {
         _loc2_ = _loc2_ + this.getCheapestValidPrice(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FITTINGS_COST[this.yachtFittings]],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FITTINGS_SALE_COST[this.yachtFittings]]);
      }
      if(this.yachtLighting != -1)
      {
         _loc2_ = _loc2_ + this.getCheapestValidPrice(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_LIGHTING_COST[this.yachtLighting]],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_LIGHTING_SALE_COST[this.yachtLighting]]);
      }
      if(this.yachtColour != -1)
      {
         _loc2_ = _loc2_ + this.getCheapestValidPrice(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_COLOUR_COST[this.yachtColour]],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_COLOUR_SALE_COST[this.yachtColour]]);
      }
      if(this.yachtFlag != -1)
      {
         _loc2_ = _loc2_ + this.getCheapestValidPrice(this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_COST],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_SALE_COST]);
   ...
   function updateTabs(page, noBluePanelAnimation)
   {
      ...
      var _loc3_ = 0;
      _loc3_ = _loc3_ + this.updateTab(_loc4_.YACHT_D_MODEL,this.yachtModel,this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_MODEL_COST[this.yachtModel]],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_MODEL_SALE_COST[this.yachtModel]]);
      _loc3_ = _loc3_ + this.updateTab(_loc4_.YACHT_D_FITTINGS,this.yachtFittings,this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FITTINGS_COST[this.yachtFittings]],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FITTINGS_SALE_COST[this.yachtFittings]]);
      _loc3_ = _loc3_ + this.updateTab(_loc4_.YACHT_D_COLOR,this.yachtColour,this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_COLOUR_COST[this.yachtColour]],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_COLOUR_SALE_COST[this.yachtColour]]);
      _loc3_ = _loc3_ + this.updateTab(_loc4_.YACHT_D_LIGHTING,this.yachtLighting,this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_LIGHTING_COST[this.yachtLighting]],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_LIGHTING_SALE_COST[this.yachtLighting]]);
      _loc3_ = _loc3_ + this.updatePersonaliseTab(_loc4_.YACHT_D_PERSONALIZE,this.yachtFlag,this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_COST],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_COST],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_FLAG_SALE_COST],this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME_SALE_COST]);
      if(_loc3_ > 0)
      {
   ...
   function updateTab(tab, value, price, salePrice)
   {
      ...
      var _loc2_ = tab.cost;
      var _loc5_ = tab.sale;
      var _loc4_ = tab.redLine;
      if(price > 0)
      {
         if(salePrice != undefined && salePrice > 0)
         {
            _loc2_.htmlText = "<B>" + this.formatPrice(price) + "</B>";
            _loc2_._x = _loc3_._x + 0.5 * (_loc3_._width - _loc2_._width);
            _loc2_._y = 61;
            _loc5_.htmlText = "<B>+" + this.formatPrice(salePrice) + "</B>";
            _loc5_._x = _loc3_._x + 0.5 * (_loc3_._width - _loc5_._width);
            _loc4_._x = _loc2_._x + _loc2_.textWidth + 7;
            _loc4_._width = _loc2_.textWidth + 10;
   ...
   function updatePersonaliseTab(tab, value, flagPrice, namePrice, flagSalePrice, nameSalePrice)
   {
      ...
      var _loc9_ = value != -1;
      var _loc10_ = this.yachtName != "" && this.yachtName != this.yachtData[com.rockstargames.gtav.web.WWW_DOCKTEASE_COM_PARENT.DATA_NAME];
      if(_loc9_ || _loc10_)
      {
         var _loc3_ = 0;
         var _loc7_ = 0;
         if(_loc9_)
         {
            _loc3_ = _loc3_ + flagPrice;
            if(flagSalePrice != undefined && flagSalePrice > 0)
            {
               _loc7_ = _loc7_ + flagSalePrice;
            }
         }
         if(_loc10_)
         {
            _loc3_ = _loc3_ + namePrice;
            if(nameSalePrice != undefined && nameSalePrice > 0)
            {
               _loc7_ = _loc7_ + nameSalePrice;
            }
         }
         if(_loc3_ > 0)
         {
            if(_loc7_ > 0)
            {
               _loc2_.htmlText = "<B>" + this.formatPrice(_loc3_) + "</B>";
               _loc2_._x = _loc4_._x + 0.5 * (_loc4_._width - _loc2_._width);
               _loc2_._y = 61;
               _loc6_.htmlText = "<B>+" + this.formatPrice(_loc7_) + "</B>";
               _loc6_._x = _loc4_._x + 0.5 * (_loc4_._width - _loc6_._width);
   ...
   function initRoundedButton(button, label, textOnColour, textOffColour, backgroundColour, backgroundAlpha)
   {
      ...
      var _loc6_ = backgroundColour >> 16 & 255;
      var _loc9_ = backgroundColour >> 8 & 255;
      var _loc5_ = backgroundColour & 255;
   ...
   function updateOptionButtons(page, buttonName, selectedIndex, numButtons, dataProviderIndex)
   {
      ...
      {
         var _loc2_ = page[buttonName + _loc3_];
   ...
   {
      var _loc2_ = this.getTotalPrice(false);
      tf.htmlText = _loc2_ <= 0?"":"<B>" + this.formatPrice(_loc2_) + "</B>";
   }
   ...
   {
      this.currentSlideIndex = this.currentSlideIndex + (step + this.numSlides);
