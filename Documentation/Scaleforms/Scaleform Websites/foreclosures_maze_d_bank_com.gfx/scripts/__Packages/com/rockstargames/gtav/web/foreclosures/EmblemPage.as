class com.rockstargames.gtav.web.foreclosures.EmblemPage extends com.rockstargames.gtav.web.foreclosures.Page
{
   ...
   function init()
   {
      ...
      this.emblems = [this.website.__get__crewEmblem()].concat(com.rockstargames.gtav.web.foreclosures.EmblemPage.IMAGES);
   ...
   function updateEmblem(emblemID)
   {
      if(emblemID == 0 && this.emblems[emblemID] == "")
      {
         ...
         var _loc4_ = _loc6_.txt;
         if(_loc4_)
         {
            _loc4_.verticalAlign = "center";
            com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setLocalisedText(_loc4_,"FORECLOSURES_NO_CREW_EMBLEM");
      ...
      var _loc5_ = this.emblems[this.website.emblem];
      if(this.website.emblem == 0)
      {
         this.view.emblemImage.tf.text = "";
         this.website.imageManager.addImage(_loc5_,_loc5_,this.view.scEmblem);
      }
      else
      {
         this.view.scEmblem.text = "";
         this.website.imageManager.addImage(com.rockstargames.gtav.web.foreclosures.EmblemPage.TXD,_loc5_,this.view.emblemImage.tf);
      }
