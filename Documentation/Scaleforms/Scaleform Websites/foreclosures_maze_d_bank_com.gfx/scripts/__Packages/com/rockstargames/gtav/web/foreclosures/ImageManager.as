class com.rockstargames.gtav.web.foreclosures.ImageManager
{
   ...
   {
      if(com.rockstargames.gtav.web.foreclosures.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == "loaded")
      {
