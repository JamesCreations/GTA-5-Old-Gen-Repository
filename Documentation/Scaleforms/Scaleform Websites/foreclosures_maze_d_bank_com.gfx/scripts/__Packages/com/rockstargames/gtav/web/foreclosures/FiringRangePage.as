class com.rockstargames.gtav.web.foreclosures.FiringRangePage extends com.rockstargames.gtav.web.foreclosures.Page
{
   ...
   function init()
   {
      ...
      if(!_loc2_.__get__isOwned() || this.website.__get__purchasedQuarters() != 1)
      {
      ...
      if(!_loc2_.__get__isOwned() || this.website.__get__purchasedBunkerGunLocker() != 1)
      {
   ...
   function initOptionButton(buttonView)
   {
      ...
      if(!this.website.getSelectedBunker().__get__isOwned() || this.website.__get__purchasedFiringRange() == 0)
      {
