class com.rockstargames.gtav.web.foreclosures.NamePage extends com.rockstargames.gtav.web.foreclosures.Page
{
   ...
   function init()
   {
      ...
      else if(this.website.__get__purchasedBikeShop() != 1)
      {
   ...
   function handleClick(type, id)
   {
      switch(type)
      {
         ...
         case "showSignageButton":
            this.website.hideSignage = this.website.hideSignage ^ 1;
            this.updateShowSignage();
      }
   }
   ...
   function updateFont()
   {
      var _loc3_ = !this.website.__get__fontsSupported()?"$Font2":com.rockstargames.gtav.levelDesign.CLUBHOUSE_NAME.FONTS[this.website.font];
