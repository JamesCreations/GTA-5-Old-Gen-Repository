class com.rockstargames.gtav.web.foreclosures.BunkerSummaryPage extends com.rockstargames.gtav.web.foreclosures.Page
{
   ...
   function initPurchaseButton()
   {
      ...
      var _loc2_ = this.website.getSelectedBunker();
      if(_loc2_.__get__isOwned() && this.website.bunkerStyle == this.website.__get__purchasedBunkerStyle() && this.website.quarters == this.website.__get__purchasedQuarters() && this.website.firingRange == this.website.__get__purchasedFiringRange() && this.website.bunkerGunLocker == this.website.__get__purchasedBunkerGunLocker() && this.website.transportation == this.website.__get__purchasedTransportation())
      {
   ...
   {
      var _loc2_ = "";
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setLocalisedText(this.view.summary,"FORECLOSURES_BUNKER_STYLE"));
      var _loc3_ = "FORECLOSURES_BUNKER_STYLE_" + (this.website.bunkerStyle + 1);
      _loc2_ = _loc2_ + (":</font> <font color=\'#333333\'>" + com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setLocalisedText(this.view.summary,_loc3_) + "</font><br>");
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setLocalisedText(this.view.summary,"FORECLOSURES_QUARTERS"));
      _loc2_ = _loc2_ + (":</font> <font color=\'#333333\'>" + com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setLocalisedText(this.view.summary,!this.website.quarters?"FORECLOSURES_NO":"FORECLOSURES_YES") + "</font><br>");
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setLocalisedText(this.view.summary,"FORECLOSURES_FIRING_RANGE"));
      ...
      _loc2_ = _loc2_ + (":</font> <font color=\'#333333\'>" + com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setLocalisedText(this.view.summary,!this.website.bunkerGunLocker?"FORECLOSURES_NO":"FORECLOSURES_YES") + "</font><br>");
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setLocalisedText(this.view.summary,"FORECLOSURES_TRANSPORTATION"));
      _loc3_ = "FORECLOSURES_NO";
   ...
   function initTotalCost()
   {
      ...
      _loc3_ = _loc3_ + _loc2_.getStyleBestCost(this.website.bunkerStyle,this.website.__get__purchasedBunkerStyle());
      if(this.website.quarters == 1 && !(_loc2_.__get__isOwned() && this.website.__get__purchasedQuarters() == 1))
      {
         _loc3_ = _loc3_ + _loc2_.getQuartersBestCost();
      }
      _loc3_ = _loc3_ + _loc2_.getFiringRangeBestCost(this.website.firingRange,this.website.__get__purchasedFiringRange());
      if(this.website.bunkerGunLocker == 1 && !(_loc2_.__get__isOwned() && this.website.__get__purchasedBunkerGunLocker() == 1))
      {
         _loc3_ = _loc3_ + _loc2_.getGunLockerBestCost();
      }
      _loc3_ = _loc3_ + _loc2_.getTransportationBestCost(this.website.transportation,this.website.__get__purchasedTransportation());
   ...
   function handleClick(type, id)
   {
      ...
      {
         case "purchaseButton":
            if(this.website.__get__purchasedBunkerID() != -1 && this.website.__get__purchasedBunkerID() != this.website.__get__selectedBunkerID())
            {
