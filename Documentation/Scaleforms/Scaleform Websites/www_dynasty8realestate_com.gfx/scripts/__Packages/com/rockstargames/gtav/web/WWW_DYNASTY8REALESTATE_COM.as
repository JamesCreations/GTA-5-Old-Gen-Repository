class com.rockstargames.gtav.web.WWW_DYNASTY8REALESTATE_COM extends com.rockstargames.ui.core.BaseWebsite
{
   ...
   function goToAnchor(AnchorLink)
   {
      ...
      {
         this.updateOptions(parseInt(_loc2_[1]));
      }
      if(_loc2_[0] == "pin")
      {
      ...
      if(_loc2_[0] == "zoomIn")
      {
         ...
         {
            this.mcScope.MapContainer.map.zoomScale = this.mcScope.MapContainer.map.zoomScale + 50;
   ...
   function sortProperties()
   {
      ...
      while(_loc6_ < this.sortedPropertyArray.length)
      {
         ...
         if(_loc4_ == true)
         {
            ...
            _loc5_._alpha = 100;
            _loc7_ = _loc7_ + (Math.round(_loc3_.background._height) + 2);
   ...
   function POPULATE_TEXT(_pageName, searchArgs, newPage)
   {
      ...
      var _loc46_ = new Array(0,2,6,10,2,6,10,20);
      var _loc44_ = new Array("No size data","DYN_FILTER_LOWEND","DYN_FILTER_MEDIUM","DYN_FILTER_HIGHEND","DYN_FILTER_LOWEND","DYN_FILTER_MEDIUM","DYN_FILTER_HIGHEND","DYN_FILTER_HIGHEND");
      var _loc47_ = new Array("No location data","DYN_FILTER_NORTHLS","DYN_FILTER_DOWNTOWN","DYN_FILTER_WESTLS","DYN_FILTER_EASTLS","DYN_FILTER_SOUTHLS","DYN_FILTER_BLAINE");
      ...
      {
         var _loc14_ = 1;
         while(_loc14_ < this.propLocArray.length)
         {
            _loc3_(this.CONTENT.localisationTF,this.propLocArray[_loc14_],0,false);
            this.propLocArray[_loc14_] = this.CONTENT.localisationTF.text;
            _loc14_ = _loc14_ + 1;
         }
      ...
      switch(this.pageName)
      {
         case "PAGE1":
            ...
            if(newPage == true)
            {
               var _loc55_ = this.mcScope.images.attachMovie("propertyTextureMC","propertyMC1",this.mcScope.images.getNextHighestDepth(),{_x:116,_y:0});
               var _loc54_ = this.mcScope.images.attachMovie("propertyTextureMC","propertyMC2",this.mcScope.images.getNextHighestDepth(),{_x:380,_y:0});
               var _loc52_ = this.mcScope.images.attachMovie("propertyTextureMC","propertyMC3",this.mcScope.images.getNextHighestDepth(),{_x:644,_y:0});
               var _loc50_ = this.mcScope.images.attachMovie("propertyTextureMC","propertyMC4",this.mcScope.images.getNextHighestDepth(),{_x:908,_y:0});
               var _loc19_ = [];
               _loc14_ = 6;
               while(_loc14_ < 36)
               {
                  var _loc13_ = false;
                  var _loc5_ = 0;
                  var _loc9_ = this.visiblePropertyIDs.length;
                  while(_loc5_ < _loc9_)
                  {
                     if(this.visiblePropertyIDs[_loc5_] == _loc14_)
                     {
                        _loc13_ = true;
                        break;
                     }
               ...
               _loc55_.updateImage("DYN_MP_" + _loc19_.splice(this.randRange(0,_loc19_.length,this.visiblePropertyIDs),1));
               _loc54_.updateImage("DYN_MP_" + _loc19_.splice(this.randRange(0,_loc19_.length,this.visiblePropertyIDs),1));
               _loc52_.updateImage("DYN_MP_" + _loc19_.splice(this.randRange(0,_loc19_.length,this.visiblePropertyIDs),1));
               _loc50_.updateImage("DYN_MP_" + _loc19_.splice(this.randRange(0,_loc19_.length,this.visiblePropertyIDs),1));
         ...
         case "LOS_D_SANTOS":
            ...
            if(this.mcScope.MapContainer.map == undefined)
            {
               ...
               _loc51_ = this.mcScope.MapContainer.attachMovie("mapMask","mapMask",this.mcScope.MapContainer.getNextHighestDepth());
               this.MapMC.setMask(_loc51_);
               ...
               _loc67_ = this.mcScope.MapContainer.attachMovie("button_zoom_in","zoomIn",this.mcScope.MapContainer.getNextHighestDepth(),{_x:265,_y:-107});
               _loc64_ = this.mcScope.MapContainer.attachMovie("button_zoom_out","zoomOut",this.mcScope.MapContainer.getNextHighestDepth(),{_x:265,_y:-83});
               var _loc66_ = this.mcScope.MapContainer.attachMovie("button_map_move","mapUP",this.mcScope.MapContainer.getNextHighestDepth(),{_x:-224,_y:-97});
               var _loc62_ = this.mcScope.MapContainer.attachMovie("button_map_move","mapDOWN",this.mcScope.MapContainer.getNextHighestDepth(),{_x:-224,_y:-57,_rotation:180});
               var _loc58_ = this.mcScope.MapContainer.attachMovie("button_map_move","mapLEFT",this.mcScope.MapContainer.getNextHighestDepth(),{_x:-244,_y:-77,_rotation:270});
               var _loc60_ = this.mcScope.MapContainer.attachMovie("button_map_move","mapRIGHT",this.mcScope.MapContainer.getNextHighestDepth(),{_x:-204,_y:-77,_rotation:90});
               ...
               var _loc10_ = new Array("priceLowToHigh","priceHighToLow");
               var _loc8_ = this.headerMC.filterButtonsMC.priceTF._x + this.headerMC.filterButtonsMC.priceTF.textWidth + 10;
               var _loc15_ = 14;
               _loc14_ = 0;
               while(_loc14_ < _loc10_.length)
               {
                  var _loc6_ = this.headerMC.filterButtonsMC[_loc10_[_loc14_]];
                  var _loc7_ = _loc6_.textTF.textWidth + 4;
                  _loc6_.textTF._width = _loc7_;
                  _loc6_.textTF._x = - _loc7_ / 2;
                  _loc6_.background._width = _loc7_;
                  _loc6_._x = _loc8_ + _loc7_ / 2;
                  _loc8_ = _loc8_ + (_loc7_ + _loc15_);
                  if(_loc14_ == 0)
                  {
                     var _loc34_ = this.headerMC.filterButtonsMC.attachMovie("nav_divider","nav_divider_price",this.headerMC.filterButtonsMC.getNextHighestDepth(),{_x:_loc8_ - _loc15_ / 2,_y:_loc6_._y});
                  }
                  _loc14_ = _loc14_ + 1;
               }
               _loc10_ = new Array("locationBlaineCounty","locationSouthLS","locationNorthLS","locationWestLS","locationEastLS","locationDowntown");
               _loc8_ = 870;
               _loc14_ = 0;
               while(_loc14_ < _loc10_.length)
               {
                  _loc6_ = this.headerMC.filterButtonsMC[_loc10_[_loc14_]];
                  _loc7_ = _loc6_.textTF.textWidth + 4;
                  _loc6_.textTF._width = _loc7_;
                  _loc6_.textTF._x = - _loc7_ / 2;
                  _loc6_.background._width = _loc7_;
                  _loc6_._x = _loc8_ - _loc7_ / 2;
                  _loc8_ = _loc8_ - (_loc7_ + _loc15_);
                  if(_loc14_ < _loc10_.length - 1)
                  {
                     _loc34_ = this.headerMC.filterButtonsMC.attachMovie("nav_divider","nav_divider_" + _loc14_,this.headerMC.filterButtonsMC.getNextHighestDepth(),{_x:_loc8_ + _loc15_ / 2,_y:_loc6_._y});
                  }
                  _loc14_ = _loc14_ + 1;
               }
               this.headerMC.filterButtonsMC.locationTF._x = _loc8_ - this.headerMC.filterButtonsMC.locationTF._width + _loc15_;
            ...
            if(this.dataProviderUI.length > 10)
            {
               ...
               _loc14_ = 0;
               while(_loc14_ < this.dataProviderUI.length)
               {
                  var _loc12_ = this.dataProviderUI[_loc14_][3];
                  if(this.dataProviderUI[_loc14_][12] && this.dataProviderUI[_loc14_][12] > 0)
                  {
                     _loc12_ = this.dataProviderUI[_loc14_][12];
                  }
                  this.propertyArray.push({PROPERTY:this.dataProviderUI[_loc14_][0],INDEX:_loc14_,XPOS:this.dataProviderUI[_loc14_][1],YPOS:this.dataProviderUI[_loc14_][2],PRICE:this.dataProviderUI[_loc14_][3],TXD:this.dataProviderUI[_loc14_][4],DESCRIPTION:this.dataProviderUI[_loc14_][5],SIZE:this.dataProviderUI[_loc14_][6],LOCATION:this.dataProviderUI[_loc14_][7],DLC:this.dataProviderUI[_loc14_][8],SALE:this.dataProviderUI[_loc14_][9],INTERIORS:this.dataProviderUI[_loc14_][10],REBATE:this.dataProviderUI[_loc14_][11],SALE_PRICE:this.dataProviderUI[_loc14_][12],SORTING_PRICE:_loc12_,IS_NEW:this.dataProviderUI[_loc14_][13] !== false});
                  this.sortedPropertyArray.push({INDEX:_loc14_,PRICE:this.dataProviderUI[_loc14_][3],VISIBLE:true,TXD:this.dataProviderUI[_loc14_][4],DLC:this.dataProviderUI[_loc14_][8],SALE:this.dataProviderUI[_loc14_][9],INTERIORS:this.dataProviderUI[_loc14_][10],REBATE:this.dataProviderUI[_loc14_][11],SALE_PRICE:this.dataProviderUI[_loc14_][12],SORTING_PRICE:_loc12_,IS_NEW:this.dataProviderUI[_loc14_][13] !== false});
                  _loc14_ = _loc14_ + 1;
               }
            }
            if(newPage == false)
            {
               var _loc57_ = this.mcScope.MapContainer.attachMovie("button_mask","button_mask",this.mcScope.MapContainer.getNextHighestDepth(),{_visible:false});
               this.browser.SET_BUTTON_MASK(this.mcScope.MapContainer.button_mask);
               var _loc53_ = this.mcScope.MapContainer.attachMovie("property_hitArea","property_hitArea",this.mcScope.MapContainer.getNextHighestDepth(),{_visible:false});
               ...
               var _loc45_ = this.propertyButtonContainer.attachMovie("shadowMC","shadowMC",this.propertyButtonContainer.getNextHighestDepth(),{_x:_loc40_ - 10,_y:_loc16_ - 5,_width:296,_visible:false});
               ...
               _loc14_ = 0;
               while(_loc14_ < this.propertyArray.length)
               {
                  pinReferenceMC._x = this.mcScope.MapContainer.map.pinContainer["pin_" + _loc14_]._x;
                  pinReferenceMC._y = this.mcScope.MapContainer.map.pinContainer["pin_" + _loc14_]._y;
                  if(this.mcScope.MapContainer.map.location_1.hitTest(pinReferenceMC) == true)
                  {
                     this.propertyArray[_loc14_].LOCATION = 1;
                  }
                  else if(this.mcScope.MapContainer.map.location_2.hitTest(pinReferenceMC) == true)
                  {
                     this.propertyArray[_loc14_].LOCATION = 2;
                  }
                  else if(this.mcScope.MapContainer.map.location_3.hitTest(pinReferenceMC) == true)
                  {
                     this.propertyArray[_loc14_].LOCATION = 3;
                  }
                  else if(this.mcScope.MapContainer.map.location_4.hitTest(pinReferenceMC) == true)
                  {
                     this.propertyArray[_loc14_].LOCATION = 4;
                  }
                  else if(this.mcScope.MapContainer.map.location_5.hitTest(pinReferenceMC) == true)
                  {
                     this.propertyArray[_loc14_].LOCATION = 5;
                  }
                  else
                  {
                     this.propertyArray[_loc14_].LOCATION = 6;
                  }
                  var _loc17_ = "property_" + _loc14_;
                  _loc2_ = this.propertyButtonContainer.attachMovie("button_propertyList",_loc17_,this.propertyButtonContainer.getNextHighestDepth(),{_x:_loc40_,_y:_loc16_});
                  _loc2_.highlight._visible = false;
                  var _loc18_ = "propertyMC" + _loc14_;
                  this.propertyMC = _loc2_.attachMovie("propertyTextureMC",_loc18_,_loc2_.getNextHighestDepth(),{_x:10,_y:9});
                  if(this.propertyArray[_loc14_].SALE && this.propertyArray[_loc14_].SALE_PRICE != this.propertyArray[_loc14_].PRICE)
                  {
                     ...
                     if(this.propertyArray[_loc14_].SALE_PRICE)
                     {
                        _loc2_.saleBanner.label.text = _loc2_.saleBanner.label.text + ": " + this.formatAmount(this.propertyArray[_loc14_].SALE_PRICE);
                     }
                     var _loc49_ = _loc2_.saleBanner.label._width;
                     _loc2_.saleBanner.right._x = _loc2_.saleBanner.label._x + _loc49_;
                  ...
                  if(this.propertyArray[_loc14_].REBATE && this.propertyArray[_loc14_].REBATE != "")
                  {
                     _loc2_.rebateBanner.swapDepths(_loc2_.getNextHighestDepth());
                     _loc2_.rebateBanner.label.textAutoSize = "shrink";
                     _loc2_.rebateBanner.label.text = this.propertyArray[_loc14_].REBATE;
                  }
                  else
                  {
                     _loc2_.rebateBanner._visible = false;
                  }
                  if(this.propertyArray[_loc14_].DLC != undefined)
                  {
                     this.propertyMC.dlcText = this.propertyArray[_loc14_].DLC;
                  }
                  _loc16_ = _loc16_ + (Math.round(_loc2_.background._height) + 2);
                  this.bottomLine = _loc16_;
                  this.dataTextScope[_loc14_] = _loc2_.btnTxt;
                  this.dataTextScope[_loc14_ + this.propertyArray.length] = this.mcScope.MapContainer.map.pinContainer["pin_" + _loc14_].btnTxt;
                  _loc14_ = _loc14_ + 1;
               }
               pinReferenceMC.removeMovieClip();
               _loc45_._height = this.bottomLine - (_loc2_.background._height - 44);
               _loc45_._visible = true;
               this.propertyButtonContainer.initHitArea(this,_loc53_);
               this.newHeight = this.bottomLine + 239;
               if(this.newHeight < 627)
               {
                  this.newHeight = 627;
         ...
         case "PROPERTY_D_DETAILS":
            ...
            if(this.propertyArray[this.pinNumber].SALE && this.propertyArray[this.pinNumber].SALE_PRICE != this.propertyArray[this.pinNumber].PRICE)
            {
               ...
               _loc49_ = this.mcScope.saleBanner.label._width;
               this.mcScope.saleBanner.right._x = this.mcScope.saleBanner.label._x + _loc49_;
            ...
            this.mcScope.propertyTF2.htmlText = this.propertyArray[this.pinNumber].PROPERTY + "       " + _loc46_[this.propertyArray[this.pinNumber].SIZE];
            ...
            _loc3_(this.mcScope.filterSizeTF,_loc44_[this.propertyArray[this.pinNumber].SIZE],0,false);
            ...
            _loc3_(this.mcScope.filterLocationTF,_loc47_[this.propertyArray[this.pinNumber].LOCATION],0,false);
            ...
            var _loc42_ = this.mcScope.descTF._y + this.mcScope.descTF.textHeight + 10;
            if(_loc42_ > this.mcScope.PURCHASE._y)
            {
               this.mcScope.PURCHASE._y = _loc42_;
               this.mcScope.PROPERTY_D_INTERIORS._y = _loc42_;
               this.mcScope.underlines._y = _loc42_;
               this.mcScope.propertyCost._y = _loc42_ + 3;
            }
         ...
         case "PROPERTY_D_INTERIORS":
            ...
            this.mcScope.LOS_D_SANTOS._x = 1064 - this.mcScope.LOS_D_SANTOS._width / 2;
            _loc14_ = 1;
            while(_loc14_ <= com.rockstargames.gtav.web.WWW_DYNASTY8REALESTATE_COM.NUM_INTERIOR_OPTIONS)
            {
               var _loc4_ = this.mcScope["PURCHASE_" + _loc14_];
               this.dataTextScope[_loc14_] = _loc4_.btnTxt;
            ...
            var _loc21_ = 1;
            var _loc20_ = this.mcScope.OPTION_0._y;
            var _loc41_ = this.mcScope.OPTION_1._y - this.mcScope.OPTION_0._y;
            ...
            while(_loc14_ < com.rockstargames.gtav.web.WWW_DYNASTY8REALESTATE_COM.NUM_INTERIOR_OPTIONS)
            {
               if((this.propertyArray[this.pinNumber].INTERIORS & _loc21_) >> _loc14_ == 0)
               {
                  this.mcScope["OPTION_" + _loc14_]._visible = false;
               }
               else
               {
                  this.mcScope["OPTION_" + _loc14_]._y = _loc20_;
                  _loc20_ = _loc20_ + _loc41_;
                  var _loc11_ = this.mcScope["OPTION_" + _loc14_].btnTxt;
                  this.dataTextScope[_loc14_ + 11] = _loc11_;
                  _loc11_.autoSize = "left";
                  _loc3_(_loc11_,"DYN_INTERIOR_OPTION_" + (_loc14_ + 1),0,false);
               }
               _loc21_ = _loc21_ << 1;
               _loc14_ = _loc14_ + 1;
            }
            ...
            _loc3_(this.mcScope.filterLocationTF,_loc47_[this.propertyArray[this.pinNumber].LOCATION],0,false);
            this.mcScope.filterLocationTF.autoSize = "left";
            this.mcScope.descTF._y = _loc20_ + 15;
            this.mcScope.descTF.autoSize = "left";
            ...
            while(_loc14_ <= com.rockstargames.gtav.web.WWW_DYNASTY8REALESTATE_COM.NUM_INTERIOR_OPTIONS)
            {
               this.mcScope["PURCHASE_" + _loc14_]._y = this.mcScope.propertyCost._y + 40;
               _loc14_ = _loc14_ + 1;
            }
            ...
            if(this.propertyArray[this.pinNumber].SALE_PRICE && this.propertyArray[this.pinNumber].SALE_PRICE != this.propertyArray[this.pinNumber].PRICE)
            {
               ...
               {
                  var _loc48_ = this.mcScope.propertyCost._width;
                  this.mcScope.propertyCost._yscale = _loc0_ = 75;
                  this.mcScope.propertyCost._xscale = _loc0_;
                  this.mcScope.propertyCost._width = _loc48_ / 0.75;
                  this.mcScope.redLine._width = 0.75 * this.mcScope.propertyCost.textWidth;
                  this.mcScope.propertyCost.htmlText = this.mcScope.propertyCost.htmlText + (" <font color=\'#cc0000\'>" + this.formatAmount(this.propertyArray[this.pinNumber].SALE_PRICE) + "</font>");
   ...
   function formatAmount(value)
   {
      ...
      if(typeof value != "string")
      {
         ...
         while(_loc1_ < _loc3_)
         {
            ...
            _loc2_ = _loc2_ + value.toString().charAt(_loc1_);
            _loc1_ = _loc1_ + 1;
         }
      }
      else
