class com.rockstargames.gtav.web.WWW_BENNYSORIGINALMOTORWORKS_COM extends com.rockstargames.gtav.web.vehicleSites.VehicleWebsite
{
   ...
   function DISABLE_VIDEO(videoDisabled)
   {
      ...
      {
         this.videoDisabled = videoDisabled || false;
      }
   }
   ...
   function POPULATE_TEXT(pageName, searchArgs, newPage)
   {
      ...
      {
         this.populateTextCount = _loc0_ = this.populateTextCount + 1;
         if(_loc0_ > 2 && pageName == this.HOME_PAGE)
         {
            return undefined;
         }
      }
   ...
   function initTopMenu(page, selected)
   {
      ...
      page.topMenu.homeButton._yscale = _loc0_ = _loc8_;
      page.topMenu.homeButton._xscale = _loc0_;
      page.topMenu.showroomButton._yscale = _loc0_ = _loc8_;
      page.topMenu.showroomButton._xscale = _loc0_;
      page.topMenu.stockButton._yscale = _loc0_ = _loc8_;
      page.topMenu.stockButton._xscale = _loc0_;
      page.topMenu.findUsButton._yscale = _loc0_ = _loc8_;
      page.topMenu.findUsButton._xscale = _loc0_;
      var _loc11_ = 200;
   ...
   function displayImage(vehicle, container)
   {
      ...
      {
         _loc3_ = _loc3_ + ("_" + vehicle.livery[Math.max(0,this.selectedOption)]);
      }
   ...
   function initVehicleButton(vehicle, container, x, y)
   {
      ...
      else
      {
         ...
         if(vehicle.secondaryPrice && vehicle.secondaryPrice != -1 && vehicle.reduction != 3)
         {
            ...
            {
               _loc2_.priceText.text = _loc2_.priceText.text + (" - " + this.formatPrice(vehicle.secondaryPrice));
            }
         }
      }
   ...
   function initOptions(page)
   {
      ...
      while(_loc3_ < _loc8_)
      {
         ...
         {
            var _loc6_ = this.currentVehicle.swatches[_loc3_] >> 16 & 255;
            var _loc7_ = this.currentVehicle.swatches[_loc3_] >> 8 & 255;
            var _loc5_ = this.currentVehicle.swatches[_loc3_] & 255;
