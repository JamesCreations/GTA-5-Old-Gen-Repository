class com.rockstargames.gtav.web.warstock.TruckModule2Page extends com.rockstargames.gtav.web.warstock.TruckPage
{
   ...
   {
      super.init();
      this.prevPageName = com.rockstargames.gtav.web.WWW_WARSTOCK_D_CACHE_D_AND_D_CARRY_COM.TRUCK_MODULE_1_PAGE;
      this.nextPageName = com.rockstargames.gtav.web.WWW_WARSTOCK_D_CACHE_D_AND_D_CARRY_COM.TRUCK_MODULE_3_PAGE;
      ...
      while(_loc3_ < this.modules.length)
      {
         ...
         if(this.modules[_loc3_].type == this.website.truckModule2)
         {
   ...
   function initModules()
   {
      ...
      {
         if(this.website.truckModule1 == _loc2_[_loc4_].type)
         {
            var _loc6_ = 0;
            while(_loc6_ < _loc2_[_loc4_].locations.length)
            {
               var _loc5_ = _loc2_[_loc4_].locations[_loc6_];
   ...
   function modulePassesUniqueTest(module)
   {
      if(module.unique)
      {
         return this.website.truckModule1 != module.type && this.website.truckModule3 != module.type;
      }
      return true;
   }
   function setDisabled(moduleData)
   {
      ...
      this.setLocalisedText(this.view.description,"CANDC_TRUCK_LOC_DISABLED_2",false);
   }
   ...
   function selectOption(option, showWarning)
   {
      ...
      while(_loc2_ < this.modules.length)
      {
         if(option == this.modules[_loc2_].label)
         {
            ...
            this.website.truckModule2 = this.website.truckModule2Prev = this.modules[_loc2_].type;
            ...
            if(this.website.truckModule3 == com.rockstargames.gtav.web.warstock.TruckPage.VOID_MODULE)
            {
               this.website.truckModule3 = this.website.truckModule3Prev;
            }
            var _loc5_ = 2;
            var _loc3_ = 0;
            while(_loc3_ < this.modules[_loc2_].locations.length)
            {
               var _loc4_ = this.modules[_loc2_].locations[_loc3_];
               if((_loc4_ & _loc5_) != 0 && _loc4_ != _loc5_)
               {
                  if(showWarning)
                  {
                     this.website.showTruckPopup("CANDC_VOID_WARN_3");
                  }
                  else
                  {
                     this.website.truckModule3 = com.rockstargames.gtav.web.warstock.TruckPage.VOID_MODULE;
