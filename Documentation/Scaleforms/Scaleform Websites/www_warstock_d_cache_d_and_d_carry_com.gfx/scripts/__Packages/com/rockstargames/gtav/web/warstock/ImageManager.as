class com.rockstargames.gtav.web.warstock.ImageManager
{
   ...
   {
      if(com.rockstargames.gtav.web.warstock.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == "loaded")
      {
