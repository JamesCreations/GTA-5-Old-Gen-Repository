class com.rockstargames.gtav.web.warstock.TruckProgressPanel
{
   ...
   function updateCosts()
   {
      ...
      this.total = this.total + this.updateCostStep(0,_loc3_,_loc2_,this.website.truckCab,this.website.__get__purchasedTruckCab());
      ...
      this.total = this.total + this.updateCostStep(1,_loc3_,_loc2_,this.website.truckModule1,this.website.__get__purchasedTruckModule1());
      _loc4_ = this.getCostIndex(this.website.truckModule2,2);
      _loc3_ = this.website.getModuleCost(_loc4_);
      _loc2_ = this.website.getModuleSaleCost(_loc4_);
      this.total = this.total + this.updateCostStep(2,_loc3_,_loc2_,this.website.truckModule2,this.website.__get__purchasedTruckModule2());
      _loc4_ = this.getCostIndex(this.website.truckModule3,4);
      _loc3_ = this.website.getModuleCost(_loc4_);
      _loc2_ = this.website.getModuleSaleCost(_loc4_);
      this.total = this.total + this.updateCostStep(3,_loc3_,_loc2_,this.website.truckModule3,this.website.__get__purchasedTruckModule3());
      _loc3_ = this.website.getColourCost(this.website.truckColour);
      _loc2_ = this.website.getColourSaleCost(this.website.truckColour);
      this.total = this.total + this.updateCostStep(4,_loc3_,_loc2_,this.website.truckColour,this.website.__get__purchasedTruckColour());
      var _loc8_ = this.website.__get__purchasedTruckCab() != -1;
   ...
   function getCostIndex(moduleType, slotNum)
   {
      ...
      {
         var _loc2_ = com.rockstargames.gtav.web.warstock.TruckProgressPanel.MODULE_DATA[_loc3_];
