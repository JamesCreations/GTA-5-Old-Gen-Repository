class com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Garage2Page extends com.rockstargames.gtav.web.dynasty8ExecutiveRealty.GaragePage
{
   function Garage2Page(website, viewContainer, pageName, isFirstPage, progressPanel, header)
   {
      ...
      this.init(9,website.__get__purchasedGarage2Equipped() == 1,false,"DYN8_EXEC_UNEQUIP_2");
   }
   function init(numberSwatchOffset, garageIsOwned, isLevel1, unequipLabel)
   {
      ...
      this.updateEquipped(this.website.garage2Equipped == 1,this.website.__get__purchasedGarage2Equipped() == 1,this.website.garage2Style,this.website.garage2Lighting,this.website.garage2Number);
      if(this.website.garage2Equipped == 1)
      {
   ...
   function initEquipButtons()
   {
      ...
      if(this.website.__get__purchasedGarage2Equipped() == 1)
      {
   ...
   function handleClick(type, id)
   {
      switch(type)
      {
         ...
         case "equipButton":
            ...
            this.updateEquipped(true,this.website.__get__purchasedGarage2Equipped() == 1,this.website.garage2Style,this.website.garage2Lighting,this.website.garage2Number);
            this.updateDisplay();
         ...
         case "unequipButton":
            ...
            this.updateEquipped(false,this.website.__get__purchasedGarage2Equipped() == 1,this.website.garage2Style,this.website.garage2Lighting,this.website.garage2Number);
            this.updateDisplay();
   ...
   function updateDisplay()
   {
      ...
      if(this.website.garage2Equipped)
      {
         ...
         _loc3_ = _loc2_.getGarage2StyleCost(this.website.garage2Style,this.website.__get__purchasedGarage2Style());
         _loc4_ = _loc2_.getGarage2StyleSaleCost(this.website.garage2Style,this.website.__get__purchasedGarage2Style());
         this.updateTab(this.view.styleTabPrices,_loc3_,_loc4_);
         _loc3_ = _loc2_.getGarage2LightingCost(this.website.garage2Lighting,this.website.__get__purchasedGarage2Lighting());
         _loc4_ = _loc2_.getGarage2LightingSaleCost(this.website.garage2Lighting,this.website.__get__purchasedGarage2Lighting());
         this.updateTab(this.view.lightingTabPrices,_loc3_,_loc4_);
         _loc3_ = _loc2_.getGarage2NumberCost(this.website.garage2Number,this.website.__get__purchasedGarage2Number());
         _loc4_ = _loc2_.getGarage2NumberSaleCost(this.website.garage2Number,this.website.__get__purchasedGarage2Number());
