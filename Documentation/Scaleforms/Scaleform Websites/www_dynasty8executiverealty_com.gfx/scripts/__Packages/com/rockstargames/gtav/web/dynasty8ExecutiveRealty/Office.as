class com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office
{
   ...
   function Office(data, _isOwned, _garageIsOwned)
   {
      ...
      this.fontSaleCosts = [data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST],data[com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Office.FONT_SALE_COST]];
   ...
   function logGarageCosts(garage1Style, garage1Lighting, garage1Number, garage2Style, garage2Lighting, garage2Number, garage3Style, garage3Lighting, garage3Number)
   {
      ...
      com.rockstargames.ui.utils.Debug.log("Office::logGarageCosts name [" + this.__get__name() + "]");
   ...
   function __get__hasGarage()
   {
      return this._hasGarage;
   }
   function __get__garageIsOwned()
   {
      return this._garageIsOwned;
   }
   function __get__garageDescription()
   {
