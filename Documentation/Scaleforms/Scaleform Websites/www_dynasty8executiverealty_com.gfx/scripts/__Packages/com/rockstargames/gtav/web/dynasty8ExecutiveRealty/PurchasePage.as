class com.rockstargames.gtav.web.dynasty8ExecutiveRealty.PurchasePage extends com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Page
{
   ...
   function init()
   {
      if(this.website.garageSelected && this.website.browser.pageName != "WAYPOINT_D_SET")
      {
         this.initGarageFlow();
      }
      else
   ...
   function initOfficeFlow()
   {
      ...
      var _loc2_ = this.website.getSelectedOffice().__get__id();
      if(_loc2_ != undefined)
      {
   ...
   function initOfficeSlideshow()
   {
      ...
      if(this.pageName == com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.PAGES.PURCHASE_PAGE.name)
      {
         var _loc2_ = [].concat(com.rockstargames.gtav.web.dynasty8ExecutiveRealty.PurchasePage.IMAGES[this.website.style]);
         var _loc3_ = this.website.getSelectedOffice();
         _loc2_[2] = _loc2_[2].substring(0,_loc2_[2].lastIndexOf("_") + 1) + _loc3_.__get__id();
      ...
      this.slideshow.show(com.rockstargames.gtav.web.dynasty8ExecutiveRealty.PurchasePage.TXD,this.website.purchaseSlideshow);
   }
   ...
   function initGarageSlideshow()
   {
      ...
      this.view.heading._y = this.view.heading._y - 72;
      this.view.description._y = this.view.description._y - 72;
   }
   function initButtons()
   {
      ...
      if(this.pageName == com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.PAGES.SUCCESS_PAGE.name)
      {
         ...
         this.view.garageButton._visible = !this.website.garageSelected;
         this.view.garageButton.disabled = this.website.garageSelected;
      }
      else
      {
