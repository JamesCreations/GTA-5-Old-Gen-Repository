class com.rockstargames.gtav.web.dynasty8ExecutiveRealty.ModShopPage extends com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Page
{
   ...
   function init()
   {
      ...
      var _loc6_ = this.website.__get__purchasedModShopEquipped() == 1;
   ...
   function initEquipButtons()
   {
      ...
      if(this.website.__get__purchasedModShopEquipped() == 1)
      {
   ...
   function updateSelectedItem()
   {
      ...
      this.view.unequipButton._visible = _loc4_ && this.website.__get__purchasedModShopEquipped() != 1;
      this.view.unequipButton.disabled = !_loc4_ || this.website.__get__purchasedModShopEquipped() == 1;
