class com.rockstargames.gtav.web.dynasty8ExecutiveRealty.SummaryPage extends com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Page
{
   ...
   function initOfficeFlow()
   {
      ...
      if(!_loc2_.__get__isOwned() || this.website.__get__purchasedBed() != 1)
      {
         this.prevPageName = com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.PAGES.BED_PAGE.name;
      }
      else if(this.website.__get__purchasedVault() != 1)
      {
   ...
   function initOfficeSlideshow()
   {
      ...
      var _loc4_ = [];
      var _loc5_ = !this.website.__get__fontsSupported()?"$Font2":com.rockstargames.gtav.web.dynasty8ExecutiveRealty.SignagePage.FONTS[this.website.font];
      ...
      var _loc3_ = this.website.__get__signage();
      if(_loc3_ == "")
      {
   ...
   function initOfficePurchaseButton()
   {
      ...
      var _loc2_ = this.website.getSelectedOffice();
      if(_loc2_.__get__isOwned() && this.website.style == this.website.__get__purchasedStyle() && this.website.personnel == this.website.__get__purchasedPersonnel() && (this.website.__get__signage() == "" || this.website.__get__signage() == this.website.__get__purchasedSignage()) && this.website.font == this.website.__get__purchasedFont() && this.website.colour == this.website.__get__purchasedColour() && this.website.gunLocker == this.website.__get__purchasedGunLocker() && this.website.vault == this.website.__get__purchasedVault() && this.website.bed == this.website.__get__purchasedBed())
      {
   ...
   function initOfficeSummary()
   {
      ...
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,"DYN8_EXEC_STYLE") + ":</font> <font color=\'#333333\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,"DYN8_EXEC_STYLE_" + this.website.style) + "</font><br>");
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,"DYN8_EXEC_PERSONNEL") + ":</font> <font color=\'#333333\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,"DYN8_EXEC_PERSONNEL_" + this.website.personnel) + "</font><br>");
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,"DYN8_EXEC_ORGANIZATION_NAME") + ":</font> <font color=\'#333333\'>" + _loc3_ + "</font><br>");
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,"DYN8_EXEC_GUN_LOCKER") + ":</font> <font color=\'#333333\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,!this.website.gunLocker?"DYN8_EXEC_NO":"DYN8_EXEC_YES") + "</font><br>");
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,"DYN8_EXEC_VAULT") + ":</font> <font color=\'#333333\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,!this.website.vault?"DYN8_EXEC_NO":"DYN8_EXEC_YES") + "</font><br>");
      _loc2_ = _loc2_ + ("<font color=\'#000000\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,"DYN8_EXEC_ACCOMMODATION") + ":</font> <font color=\'#333333\'>" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setLocalisedText(this.view.summary,!this.website.bed?"DYN8_EXEC_NO":"DYN8_EXEC_YES") + "</font>");
   ...
   function initOfficeTotalCost()
   {
      ...
      _loc3_ = _loc3_ + _loc2_.getStyleBestCost(this.website.style,this.website.__get__purchasedStyle());
      _loc3_ = _loc3_ + _loc2_.getPersonnelBestCost(this.website.personnel,this.website.__get__purchasedPersonnel());
      ...
      _loc3_ = _loc3_ + _loc2_.getVaultBestCost(this.website.vault,this.website.__get__purchasedVault());
      _loc3_ = _loc3_ + _loc2_.getBedBestCost(this.website.bed,this.website.__get__purchasedBed());
      this.view.cost.text = "$" + com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.formatNumber(_loc3_);
   }
   ...
   function initGaragePurchaseButton()
   {
      ...
      var _loc4_ = this.website.__get__purchasedModShopEquipped() != -1 && this.website.__get__purchasedModShopEquipped() != 0;
      if(_loc5_ && !_loc4_)
      {
         _loc3_ = false;
      }
      ...
      {
         if(!(this.website.modShop == 0 && this.website.__get__purchasedModShop() == -1))
         {
            if(this.website.modShop != this.website.__get__purchasedModShop())
            {
               _loc3_ = false;
            }
         }
      ...
      if(this.website.garage1Equipped == 1)
      {
         if(this.website.garage1Style != this.website.__get__purchasedGarage1Style() || this.website.garage1Lighting != this.website.__get__purchasedGarage1Lighting() || this.website.garage1Number != this.website.__get__purchasedGarage1Number())
         {
            _loc2_ = false;
         }
      }
      if(this.website.garage2Equipped == 1)
      {
         if(this.website.garage2Style != this.website.__get__purchasedGarage2Style() || this.website.garage2Lighting != this.website.__get__purchasedGarage2Lighting() || this.website.garage2Number != this.website.__get__purchasedGarage2Number())
         {
            _loc2_ = false;
         }
      }
      if(this.website.garage3Equipped == 1)
      {
         if(this.website.garage3Style != this.website.__get__purchasedGarage3Style() || this.website.garage3Lighting != this.website.__get__purchasedGarage3Lighting() || this.website.garage3Number != this.website.__get__purchasedGarage3Number())
         {
            _loc2_ = false;
         }
      }
   ...
   function initGarageTotalCost()
   {
      ...
      com.rockstargames.ui.utils.Debug.log("SummaryPage:: logging garage costs...");
      com.rockstargames.ui.utils.Debug.log("*****************************************************************************");
      ...
      {
         _loc2_ = _loc2_ + _loc3_.getGarage1StyleBestCost(this.website.garage1Style,this.website.__get__purchasedGarage1Style());
         _loc2_ = _loc2_ + _loc3_.getGarage1LightingBestCost(this.website.garage1Lighting,this.website.__get__purchasedGarage1Lighting());
         _loc2_ = _loc2_ + _loc3_.getGarage1NumberBestCost(this.website.garage1Number,this.website.__get__purchasedGarage1Number());
      }
      if(this.website.garage2Equipped)
      {
         _loc2_ = _loc2_ + _loc3_.getGarage2StyleBestCost(this.website.garage2Style,this.website.__get__purchasedGarage2Style());
         _loc2_ = _loc2_ + _loc3_.getGarage2LightingBestCost(this.website.garage2Lighting,this.website.__get__purchasedGarage2Lighting());
         _loc2_ = _loc2_ + _loc3_.getGarage2NumberBestCost(this.website.garage2Number,this.website.__get__purchasedGarage2Number());
      }
      if(this.website.garage3Equipped)
      {
         _loc2_ = _loc2_ + _loc3_.getGarage3StyleBestCost(this.website.garage3Style,this.website.__get__purchasedGarage3Style());
         _loc2_ = _loc2_ + _loc3_.getGarage3LightingBestCost(this.website.garage3Lighting,this.website.__get__purchasedGarage3Lighting());
         _loc2_ = _loc2_ + _loc3_.getGarage3NumberBestCost(this.website.garage3Number,this.website.__get__purchasedGarage3Number());
      }
      if(this.website.modShopEquipped)
      {
         _loc2_ = _loc2_ + _loc3_.getModShopBestCost(this.website.modShop,this.website.__get__purchasedModShop());
      }
