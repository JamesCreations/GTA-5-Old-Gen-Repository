class com.rockstargames.gtav.web.dynasty8ExecutiveRealty.OrganisationNameColour
{
   ...
   static function getColourEnum(styleIndex, colourIndex)
   {
      while(styleIndex < 0)
      {
         styleIndex = styleIndex + com.rockstargames.gtav.web.dynasty8ExecutiveRealty.OrganisationNameColour.COLOUR_SCHEMES_BY_STYLE.length;
      }
      styleIndex = styleIndex % com.rockstargames.gtav.web.dynasty8ExecutiveRealty.OrganisationNameColour.COLOUR_SCHEMES_BY_STYLE.length;
      while(colourIndex < 0)
      {
         colourIndex = colourIndex + com.rockstargames.gtav.web.dynasty8ExecutiveRealty.OrganisationNameColour.COLOUR_SCHEMES_BY_STYLE[styleIndex].length;
      }
      colourIndex = colourIndex % com.rockstargames.gtav.web.dynasty8ExecutiveRealty.OrganisationNameColour.COLOUR_SCHEMES_BY_STYLE[styleIndex].length;
