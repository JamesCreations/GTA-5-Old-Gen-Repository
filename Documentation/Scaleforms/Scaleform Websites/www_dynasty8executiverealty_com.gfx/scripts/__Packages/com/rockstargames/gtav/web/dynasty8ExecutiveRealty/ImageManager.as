class com.rockstargames.gtav.web.dynasty8ExecutiveRealty.ImageManager
{
   ...
   {
      if(com.rockstargames.gtav.web.dynasty8ExecutiveRealty.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == "loaded")
      {
      ...
      else
      {
         ...
         {
            com.rockstargames.ui.game.GameInterface.call("REQUEST_TXD_AND_ADD_REF",com.rockstargames.ui.game.GameInterface.GENERIC_TYPE,"WEB_BROWSER",txd,id,true);
