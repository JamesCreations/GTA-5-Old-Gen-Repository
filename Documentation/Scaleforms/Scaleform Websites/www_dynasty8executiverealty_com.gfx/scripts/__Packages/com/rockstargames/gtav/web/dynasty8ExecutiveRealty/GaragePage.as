class com.rockstargames.gtav.web.dynasty8ExecutiveRealty.GaragePage extends com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Page
{
   ...
   {
      if(salePrice > 0 && originalPrice > -1)
      {
         tabView.price.text = "";
