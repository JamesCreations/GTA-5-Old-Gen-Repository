class com.rockstargames.gtav.web.WWW_LCN_D_EXCHANGE_COM extends com.rockstargames.ui.core.BaseWebsite
{
   var lineXPos = 220;
   var lineYPos = 271;
   var lineSpacing = 34;
   ...
   {
      super();
      this._name = "WWW_LCN_D_EXCHANGE_COM";
      ...
      this.scriptAccessibleMovieClips = ["WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_BUY","WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_SELL"];
      ...
      switch(_loc15_)
      {
         case "NEWS":
            ...
            while(_loc3_ < this.dataProviderUI.length)
            {
               ...
               {
                  _loc6_ = _loc6_ + (_loc12_ + _loc4_ + _loc11_ + this.dataProviderUI[_loc3_] + _loc7_ + _loc4_);
               }
               _loc3_ = _loc3_ + 1;
            }
         ...
         case "STOCK":
            ...
            while(_loc3_ < this.dataProviderUI.length)
            {
               if(this.dataProviderUI[_loc3_][0] != undefined)
               {
                  ...
                  _loc6_ = _loc6_ + (_loc12_ + _loc4_ + _loc11_ + _loc9_ + _loc4_ + com.rockstargames.gtav.utils.ROUND_DECIMAL_PLACES.roundDecimals(_loc10_,2) + _loc7_ + _loc4_);
                  if(_loc5_ < 0)
                  {
                     _loc6_ = _loc6_ + (_loc14_ + com.rockstargames.gtav.utils.ROUND_DECIMAL_PLACES.roundDecimals(Math.abs(_loc5_),2) + "<img src=\'down_arrow\' height=\'12\' width=\'12\'>" + com.rockstargames.gtav.utils.ROUND_DECIMAL_PLACES.roundDecimals(Math.abs(_loc8_),2) + "%" + _loc7_ + _loc4_);
                  }
                  else
                  {
                     _loc6_ = _loc6_ + (_loc13_ + com.rockstargames.gtav.utils.ROUND_DECIMAL_PLACES.roundDecimals(Math.abs(_loc5_),2) + "<img src=\'up_arrow\' height=\'12\' width=\'12\'>" + com.rockstargames.gtav.utils.ROUND_DECIMAL_PLACES.roundDecimals(Math.abs(_loc8_),2) + "%" + _loc7_ + _loc4_);
                  }
               }
               _loc3_ = _loc3_ + 1;
            }
   ...
   function PROXY_FUNCTION()
   {
      ...
      this.register4(_loc3_.slice(1));
   }
   function SET_BAWSAQ_PLAYER_CASH()
   {
      var _loc4_ = this.CONTENT.playerCashMC.playerCashTF;
      var _loc5_ = this.CONTENT.playerCashMC.cashTitleTF;
      var _loc3_ = arguments;
      var _loc6_ = String(_loc3_[0]);
      this.set_price_text(_loc4_,_loc3_[0]);
      this.setTextWithTranslation(_loc5_,"BS_WB_MCASH");
   ...
   function POPULATE_TEXT(pageName)
   {
      ...
      {
         this.browser.GO_TO_WEBPAGE("WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO_EMPTY");
      }
      switch(pageName)
      {
         case "PAGE1":
            ...
            this.dataTextScope[0] = this.mcScope.WWW_LCN_D_EXCHANGE_COM.txt;
            this.dataTextScope[1] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS.btnTxt;
            this.dataTextScope[2] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_LISTINGS.btnTxt;
            this.dataTextScope[3] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.dataTextScope[4] = this.mcScope.WWW_BAWSAQ_COM.btnTxt;
            this.mcScope.WWW_BAWSAQ_COM.btnTxt._visible = false;
            ...
            com.rockstargames.gtav.web.DynamicGraph.draw(this.dataProviderUI[27],this.dataProviderUI[28],this.mcScope.page1Graph,1525208);
            this.setTextWithTranslation(this.mcScope.headerMovers,"BS_WB_MOVERS");
            this.setTextWithTranslation(this.mcScope.topFive_company,"BS_WB_NAMEH_SHORT");
            this.setTextWithTranslation(this.mcScope.topFive_price,"BS_WB_CURPRICH_SHORT");
            this.setTextWithTranslation(this.mcScope.topFive_change,"BS_H_CHNG");
            this.setTextWithTranslation(this.mcScope.graphTitle,"BS_PH_GR");
            break;
         case "LISTINGS":
            this.mcScope = this.CONTENT.LISTINGS;
            this.listPageURL = "WWW_LCN_D_EXCHANGE_COM_S_STOCK_VIEW";
            if(this.sortSlot == 6)
            {
               this.sortSlot = 3;
               this.sortDirection = 1;
            ...
            this.dataTextScope = new Array();
            this.dataTextScope[0] = this.mcScope.WWW_LCN_D_EXCHANGE_COM.btnTxt;
            this.dataTextScope[1] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS.btnTxt;
            this.dataTextScope[2] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_LISTINGS.txt;
            this.dataTextScope[3] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.dataTextScope[4] = this.mcScope.WWW_BAWSAQ_COM_S_LISTINGS.btnTxt;
            this.mcScope.WWW_BAWSAQ_COM_S_LISTINGS.btnTxt._visible = false;
            ...
            this.dataTextScope[13] = this.mcScope.WWW_BAWSAQ_COM_S_LISTINGS_S_.btnTxt;
         ...
         case "STOCK_PORTFOLIO":
            ...
            this.dataTextScope[1] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS.btnTxt;
            this.dataTextScope[2] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_LISTINGS.btnTxt;
            this.dataTextScope[3] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO.txt;
            this.dataTextScope[4] = this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt._visible = false;
            ...
            this.dataTextScope[13] = this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO_S_.btnTxt;
            this.dataTextScope[14] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO_SELL_D_ALL.btnTxt;
            this.ADD_TEXT(this.dataTextScope.length);
            this.CONTENT.BOUNDING_BOX._height = 627;
            this.indexStart = 15;
            this.lineXPos = 220;
            ...
            this.updateSortSlotArrow(this.sortSlot);
            this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO_SELL_D_ALL._y = this.lineSpacing * _loc5_ + this.lineYPos + 10;
            this.SET_NEW_PAGE_HEIGHT(this.dataTextScope);
            this.browser.SET_PAGE_BUTTONS(this.dataTextScope);
            break;
         case "STOCK_PORTFOLIO_EMPTY":
            ...
            this.dataTextScope[7] = this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO_S_.btnTxt;
            this.ADD_TEXT(this.dataTextScope.length);
            this.browser.SET_PAGE_BUTTONS(this.dataTextScope);
            this.CONTENT.BOUNDING_BOX._height = 627;
            break;
         case "STOCK_VIEW":
            ...
            this.dataTextScope[17] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_BUY.btnTxt;
            this.dataTextScope[18] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_SELL.btnTxt;
            ...
            this.dataTextScope[37] = this.mcScope.WWW_BAWSAQ_COM_S_LISTINGS.btnTxt;
            this.mcScope.WWW_BAWSAQ_COM_S_LISTINGS.btnTxt._visible = false;
            this.ADD_TEXT(this.dataTextScope.length);
            this.setTextWithTranslation(this.mcScope.graphChangePercentLabel,"BS_WB_PERCHA");
            this.mcScope.graphChangePercentValue.text = this.mcScope.changePercentValue.text;
            var _loc3_ = this.dataProviderUI[10][0];
            var _loc7_ = " (" + _loc3_ + ")";
            this.dataTextScope[5].text = this.dataTextScope[5].text + _loc7_;
            ...
            {
               this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_SELL._alpha = 100;
               this.SET_MOVIECLIP_VISIBILITY(true,1);
            }
            this.CONTENT.BOUNDING_BOX._height = 640;
            com.rockstargames.gtav.web.DynamicGraph.draw(this.dataProviderUI[37],this.dataProviderUI[38],this.mcScope.stockViewGraph,1525208);
         ...
         case "STOCK_TRADE_BUY":
            ...
            if(this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_CONFIRM == undefined)
            {
               this.mcScope.attachMovie("button_GREEN","WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_CONFIRM",this.mcScope.getNextHighestDepth(),{_x:562,_y:414});
            }
            this.dataTextScope[20] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_CONFIRM.btnTxt;
            ...
            _loc7_ = " (" + _loc3_ + ")";
            this.dataTextScope[7].text = this.dataTextScope[7].text + _loc7_;
            this.setAndPositionLogo(_loc3_);
            ...
            this.dataTextScope[30] = this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt._visible = false;
            this.setTextWithTranslation(this.mcScope.stockInfoHeader,"BS_WB_STCKINF");
            this.browser.SET_PAGE_BUTTONS(this.dataTextScope);
         ...
         case "STOCK_TRADE_SELL":
            ...
            if(this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_CONFIRM == undefined)
            {
               this.mcScope.attachMovie("button_RED","WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_CONFIRM",this.mcScope.getNextHighestDepth(),{_x:538.7,_y:409,_width:144.3,_height:33.75});
            }
            this.dataTextScope[20] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_CONFIRM.btnTxt;
            this.dataTextScope[21] = this.mcScope.PLUS_BUTTON.btnTxt;
            this.dataTextScope[22] = this.mcScope.MINUS_BUTTON.btnTxt;
            ...
            this.dataTextScope[28] = this.mcScope.shareValueLabel;
            this.dataTextScope[29] = this.mcScope.shareValueValue;
            if(this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_CONFIRM_S_ == undefined)
            {
               this.mcScope.attachMovie("button_RED","WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_CONFIRM_S_",this.mcScope.getNextHighestDepth(),{_x:438,_y:414});
            }
            this.dataTextScope[30] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_TRADE_CONFIRM_S_.btnTxt;
            this.dataTextScope[31] = this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt._visible = false;
            this.ADD_TEXT(this.dataTextScope.length);
            this.setTextWithTranslation(this.mcScope.stockInfoHeader,"BS_WB_STCKINF");
            _loc3_ = this.dataProviderUI[6][0];
         ...
         case "STOCK_TRADE_CONFIRM":
            ...
            this.dataTextScope[18] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_CONFIRMED.btnTxt;
            this.dataTextScope[19] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_VIEW.btnTxt;
            ...
            this.dataTextScope[27] = this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt._visible = false;
            this.ADD_TEXT(this.dataTextScope.length);
         ...
         case "CONFIRMED":
            ...
            this.dataTextScope[2] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_LISTINGS.btnTxt;
            this.dataTextScope[3] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.dataTextScope[4] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO_S_.btnTxt;
            this.dataTextScope[5] = this.mcScope.header;
            this.dataTextScope[6] = this.mcScope.companyAbv;
            this.dataTextScope[7] = this.mcScope.sharesAndCompanyName;
            ...
            this.dataTextScope[24] = this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO.btnTxt._visible = false;
            this.browser.SET_PAGE_BUTTONS(this.dataTextScope);
            if(!this.isSellingAll)
            {
            ...
            {
               this.setTextWithTranslation(this.mcScope.stockInfoHeader,"BS_WB_INVINF");
            }
         ...
         case "NEWS":
            ...
            this.dataTextScope = new Array();
            this.dataTextScope[0] = this.mcScope.WWW_LCN_D_EXCHANGE_COM.btnTxt;
            this.dataTextScope[1] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS.txt;
            this.dataTextScope[2] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_LISTINGS.btnTxt;
            this.dataTextScope[3] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.dataTextScope[4] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_S_.txt;
            this.dataTextScope[5] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_CITY.btnTxt;
            this.dataTextScope[6] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_MONEY.btnTxt;
            this.dataTextScope[7] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_TECHNOLOGY.btnTxt;
            ...
            this.dataTextScope[15] = this.mcScope.WWW_BAWSAQ_COM_S_NEWS.btnTxt;
            this.mcScope.WWW_BAWSAQ_COM_S_NEWS.btnTxt._visible = false;
            this.ADD_TEXT(this.dataTextScope.length);
            this.browser.SET_PAGE_BUTTONS(this.dataTextScope);
         ...
         case "NEWS_CITY":
            ...
            this.dataTextScope[2] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_LISTINGS.btnTxt;
            this.dataTextScope[3] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO.btnTxt;
            this.dataTextScope[4] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_S_.btnTxt;
            this.dataTextScope[5] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_CITY.txt;
            this.dataTextScope[6] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_MONEY.btnTxt;
            this.dataTextScope[7] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_TECHNOLOGY.btnTxt;
            this.dataTextScope[8] = this.mcScope.header;
            this.dataTextScope[9] = this.mcScope.newsItem1.header;
         ...
         case "NEWS_MONEY":
            ...
            this.dataTextScope[4] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_S_.btnTxt;
            this.dataTextScope[5] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_CITY.btnTxt;
            this.dataTextScope[6] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_MONEY.txt;
            this.dataTextScope[7] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_TECHNOLOGY.btnTxt;
            this.dataTextScope[8] = this.mcScope.header;
            this.dataTextScope[9] = this.mcScope.newsItem1.header;
            this.dataTextScope[10] = this.mcScope.newsItem1.body;
         ...
         case "NEWS_TECHNOLOGY":
            ...
            this.dataTextScope[5] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_CITY.btnTxt;
            this.dataTextScope[6] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_MONEY.btnTxt;
            this.dataTextScope[7] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_NEWS_TECHNOLOGY.txt;
            this.dataTextScope[8] = this.mcScope.header;
            this.dataTextScope[9] = this.mcScope.newsItem1.header;
            this.dataTextScope[10] = this.mcScope.newsItem1.body;
            this.mcScope.newsItem1.body.autoSize = "left";
         ...
         case "STOCK_PORTFOLIO_SELL_D_ALL":
            ...
            this.dataTextScope[5] = this.mcScope.header;
            this.dataTextScope[6] = this.mcScope.message;
            if(this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_CONFIRMED == undefined)
            {
               this.mcScope.attachMovie("button_GREEN","WWW_LCN_D_EXCHANGE_COM_S_CONFIRMED",this.mcScope.getNextHighestDepth(),{_x:970,_y:360});
            }
            this.dataTextScope[7] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_CONFIRMED.btnTxt;
            if(this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO_S_ == undefined)
            {
               this.mcScope.attachMovie("button_RED","WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO_S_",this.mcScope.getNextHighestDepth(),{_x:848,_y:360});
            }
            this.dataTextScope[8] = this.mcScope.WWW_LCN_D_EXCHANGE_COM_S_STOCK_PORTFOLIO_S_.btnTxt;
            this.dataTextScope[9] = this.mcScope.WWW_BAWSAQ_COM_S_STOCK_PORTFOLIO_S_.btnTxt;
            this.ADD_TEXT(this.dataTextScope.length);
            this.browser.SET_PAGE_BUTTONS(this.dataTextScope);
            this.CONTENT.BOUNDING_BOX._height = 627;
      }
   ...
   function MAKE_STOCK_LIST(indexStart, dataLength, stocks)
   {
      ...
      while(_loc7_ < dataLength - indexStart)
      {
         ...
         if(this.stockArray[_loc3_] != undefined && this.stockArray[_loc3_].length > 1)
         {
            ...
            this.container[_loc2_].onColour = 2236962;
            this.container[_loc2_].offColour = 2236962;
   ...
   function setAndPositionLogo(companyAbv)
   {
      ...
      var _loc2_ = 10;
      if(this.mcScope.companyLogo._height > this.mcScope.headerBg._height - _loc2_ * 2)
      {
         var _loc3_ = (this.mcScope.headerBg._height - _loc2_ * 2) / this.mcScope.companyLogo._height * 100;
         this.mcScope.companyLogo._xscale = this.mcScope.companyLogo._yscale = _loc3_;
      }
      this.mcScope.companyLogo._x = this.mcScope.headerBg._x + this.mcScope.headerBg._width - (this.mcScope.companyLogo._width + _loc2_);
   ...
   function set_price_text(TF, price)
   {
      ...
      while(_loc1_ < _loc3_)
      {
         ...
         _loc2_ = _loc2_ + price.toString().charAt(_loc1_);
         _loc1_ = _loc1_ + 1;
      }
      TF.text = _loc2_;
   }
